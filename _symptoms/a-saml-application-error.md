---
title: A SAML application error
slug: a-saml-application-error
description: 'Observable report: A SAML application error. Select it with any other symptoms to receive ranked procedures.'
