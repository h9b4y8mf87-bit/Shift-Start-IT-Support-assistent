---
title: High load on Linux
slug: high-load-on-linux
description: 'Observable report: High load on Linux. Select it with any other symptoms to receive ranked procedures.'
