---
title: A disabled user account
slug: a-disabled-user-account
description: 'Observable report: A disabled user account. Select it with any other symptoms to receive ranked procedures.'
