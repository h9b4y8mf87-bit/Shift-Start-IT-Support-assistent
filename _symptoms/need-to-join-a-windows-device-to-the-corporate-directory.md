---
title: Need to join a Windows device to the corporate directory
slug: need-to-join-a-windows-device-to-the-corporate-directory
description: 'Observable report: Need to join a Windows device to the corporate directory. Select it with any other symptoms to receive ranked procedures.'
content_type: symptom
category: Windows Endpoints
severity: medium
tags:
  - join-a-windows-device-to-the-corporate-directory
  - windows-endpoints
related_procedures:
  - join-a-windows-device-to-the-corporate-directory
permalink: /symptoms/need-to-join-a-windows-device-to-the-corporate-directory/
layout: article
