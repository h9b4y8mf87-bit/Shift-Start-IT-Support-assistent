...
description: 'Observable report: Reset approved access to an Azure virtual machine. Select it with any other symptoms to receive ranked procedures.'
...
related_procedures:
  - reset-approved-access-to-an-azure-virtual-machine
permalink: /symptoms/reset-approved-access-to-an-azure-virtual-machine/
layout: article
