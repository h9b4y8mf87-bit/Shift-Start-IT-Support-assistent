...
slug: known-folder-move
description: 'Observable report: Known Folder Move. Select it with any other symptoms to receive ranked procedures.'
...
related_procedures:
- troubleshoot-known-folder-move
permalink: /symptoms/known-folder-move/
layout: article
