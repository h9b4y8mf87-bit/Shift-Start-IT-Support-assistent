...
description: Enterprise runbook to troubleshoot a failing storage device without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a failing storage device, verify the original business task, and escalate with complete
