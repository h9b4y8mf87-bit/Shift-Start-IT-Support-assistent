...
description: 'Enterprise runbook to offboard and recover a departing employee device without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - recover
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for offboard and recover a departing employee device, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - offboard-and-recover-a-departing-employee-device
  - a-device-software-or-asset-lifecycle-request-is-required
symptom_weights:
  offboard-and-recover-a-departing-employee-device: 10
...
permalink: /procedures/offboard-and-recover-a-departing-employee-device/
layout: article
