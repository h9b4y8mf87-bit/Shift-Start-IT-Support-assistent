...
description: Enterprise runbook to offboard and recover a departing employee device without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for offboard and recover a departing employee device, verify the original business task, and escalate
