---
title: Troubleshoot meeting updates or cancellations
slug: troubleshoot-meeting-updates-or-cancellations
description: 'Enterprise runbook to troubleshoot meeting updates or cancellations without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - updates
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot meeting updates or cancellations, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - meeting-updates-or-cancellations
  - microsoft-365-feature-is-not-working
  - cloud-collaboration-access-is-failing
symptom_weights:
  meeting-updates-or-cancellations: 10
...
permalink: /procedures/troubleshoot-meeting-updates-or-cancellations/
layout: article
