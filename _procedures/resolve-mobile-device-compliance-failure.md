...
description: >-
  Enterprise runbook to resolve mobile-device compliance failure without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for resolve mobile-device compliance failure, verify the original business task, and escalate with
