...
description: Enterprise runbook to troubleshoot a default gateway failure without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a default gateway failure, verify the original business task, and escalate with complete
