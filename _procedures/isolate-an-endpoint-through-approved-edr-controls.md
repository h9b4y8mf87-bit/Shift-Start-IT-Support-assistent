...
description: >-
  Enterprise runbook to isolate an endpoint through approved edr controls without skipping evidence, verification,
...
tldr: >-
  ...
  remediation for isolate an endpoint through approved edr controls, verify the original business task, and escalate
