...
permalink: /procedures/troubleshoot-no-dial-tone-on-a-desk-phone/
layout: article
...
canonical_procedure: troubleshoot-a-teams-phone-device
deprecation_reason: Merged into troubleshoot-a-teams-phone-device during Batch B-6 audit.
---
## Deprecated — use the canonical procedure
This page has been consolidated into `troubleshoot-a-teams-phone-device`.

Use `/procedures/troubleshoot-a-teams-phone-device/`.
