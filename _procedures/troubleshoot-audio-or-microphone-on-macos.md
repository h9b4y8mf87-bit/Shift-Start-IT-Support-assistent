...
description: Enterprise runbook to troubleshoot audio or microphone on macos without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot audio or microphone on macos, verify the original business task, and escalate with
