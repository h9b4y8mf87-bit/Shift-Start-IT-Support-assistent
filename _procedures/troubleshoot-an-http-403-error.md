...
description: >-
  Enterprise runbook to troubleshoot an http 403 error without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot an http 403 error, verify the original business task, and escalate with complete logs if
