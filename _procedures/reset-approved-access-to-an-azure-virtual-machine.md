...
description: >-
  Enterprise runbook to reset approved access to an azure virtual machine without skipping evidence, verification,
...
tldr: >-
  ...
  remediation for reset approved access to an azure virtual machine, verify the original business task, and escalate
