---
title: Reset approved access to an Azure virtual machine
slug: reset-approved-access-to-an-azure-virtual-machine
description: Enterprise runbook to reset approved access to an azure virtual machine without skipping evidence, verification, rollback or escalation requirements.
...
- virtual
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for reset approved access to an azure virtual machine, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- reset-approved-access-to-an-azure-virtual-machine
- a-cloud-or-virtual-resource-is-degraded
symptom_weights:
  reset-approved-access-to-an-azure-virtual-machine: 10
...
permalink: /procedures/reset-approved-access-to-an-azure-virtual-machine/
layout: article
