...
description: >-
  Enterprise runbook to triage a web server http 500 error without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for triage a web server http 500 error, verify the original business task, and escalate with complete logs
