...
description: Enterprise runbook to triage a web server http 500 error without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for triage a web server http 500 error, verify the original business task, and escalate with complete
