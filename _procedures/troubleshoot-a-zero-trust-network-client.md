---
title: Troubleshoot a zero-trust network client
slug: troubleshoot-a-zero-trust-network-client
description: 'Enterprise runbook to troubleshoot a zero-trust network client without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - zero
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot a zero-trust network client, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - a-zero-trust-network-client
  - network-or-internet-access-is-unavailable
  - connection-is-slow-or-intermittent
symptom_weights:
  a-zero-trust-network-client: 10
...
permalink: /procedures/troubleshoot-a-zero-trust-network-client/
layout: article
