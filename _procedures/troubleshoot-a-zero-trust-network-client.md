...
description: Enterprise runbook to troubleshoot a zero-trust network client without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a zero-trust network client, verify the original business task, and escalate with
