...
description: Enterprise runbook to troubleshoot disk-encryption compliance without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot disk-encryption compliance, verify the original business task, and escalate with
