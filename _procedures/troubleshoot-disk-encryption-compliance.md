...
description: >-
  Enterprise runbook to troubleshoot disk-encryption compliance without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for troubleshoot disk-encryption compliance, verify the original business task, and escalate with complete
