...
description: >-
  Enterprise runbook to perform a device health check without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for perform a device health check, verify the original business task, and escalate with complete logs if
