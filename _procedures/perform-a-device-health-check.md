...
description: Enterprise runbook to perform a device health check without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for perform a device health check, verify the original business task, and escalate with complete logs
