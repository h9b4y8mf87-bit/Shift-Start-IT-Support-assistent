---
title: Triage a site-wide LAN outage
slug: triage-a-site-wide-lan-outage
description: 'Enterprise runbook to triage a site-wide lan outage without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - wide
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for triage a site-wide lan outage, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - a-site-wide-lan-outage
  - network-or-internet-access-is-unavailable
  - connection-is-slow-or-intermittent
symptom_weights:
  a-site-wide-lan-outage: 10
...
permalink: /procedures/triage-a-site-wide-lan-outage/
layout: article
...
The exact scenario “Triage a site-wide LAN outage” is resolved and the original business task succeeds.
