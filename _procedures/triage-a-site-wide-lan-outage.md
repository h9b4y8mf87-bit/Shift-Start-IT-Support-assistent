...
description: >-
  Enterprise runbook to triage a site-wide lan outage without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for triage a site-wide lan outage, verify the original business task, and escalate with complete logs if
