...
description: Enterprise runbook to triage a site-wide lan outage without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for triage a site-wide lan outage, verify the original business task, and escalate with complete logs
