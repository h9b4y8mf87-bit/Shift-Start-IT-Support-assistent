...
description: Enterprise runbook to troubleshoot office activation without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot office activation, verify the original business task, and escalate with complete
