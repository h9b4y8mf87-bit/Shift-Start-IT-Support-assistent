---
title: Troubleshoot a desktop with no power
slug: troubleshoot-a-desktop-with-no-power
description: 'Enterprise runbook to troubleshoot a desktop with no power without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - with
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot a desktop with no power, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - a-desktop-with-no-power
  - hardware-or-peripheral-is-not-functioning
symptom_weights:
  a-desktop-with-no-power: 10
...
permalink: /procedures/troubleshoot-a-desktop-with-no-power/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot a desktop with no power** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Confirm the exact condition described by “Troubleshoot a desktop with no power” and identify its first failing dependency.
...
The exact scenario “Troubleshoot a desktop with no power” is resolved and the original business task succeeds.
