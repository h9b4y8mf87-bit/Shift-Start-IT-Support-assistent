...
description: Enterprise runbook to troubleshoot a desktop with no power without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a desktop with no power, verify the original business task, and escalate with complete
