...
description: Enterprise runbook to troubleshoot a firewall-blocked application without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a firewall-blocked application, verify the original business task, and escalate with
...
escalation: Escalate to Network Operations with the exact user or service impact, timestamps and timezone, affected
