...
description: Enterprise runbook to troubleshoot a docking station display issue without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a docking station display issue, verify the original business task, and escalate
