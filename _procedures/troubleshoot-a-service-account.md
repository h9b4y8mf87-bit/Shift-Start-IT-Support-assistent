...
description: >-
  Enterprise runbook to troubleshoot a service account without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot a service account, verify the original business task, and escalate with complete logs if
