...
description: Enterprise runbook to troubleshoot a teams room system offline without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a teams room system offline, verify the original business task, and escalate with
