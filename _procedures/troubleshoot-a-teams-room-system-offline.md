---
title: Troubleshoot a Teams Room system offline
slug: troubleshoot-a-teams-room-system-offline
description: 'Enterprise runbook to troubleshoot a teams room system offline without skipping evidence, verification, rollback or escalation requirements.'
...
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot a teams room system offline, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - a-teams-room-system-offline
  - calling-audio-video-or-meeting-room-technology-is-not-working
symptom_weights:
  a-teams-room-system-offline: 10
...
permalink: /procedures/troubleshoot-a-teams-room-system-offline/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot a teams room system offline** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.

## Mandatory Batch B-2 controls
These audit-derived controls are mandatory before more invasive remediation.

### Pre-checks
1. Check room-system power, network link and console error state.
2. Check device registration/health in Teams Rooms management or the Teams Admin Center.
3. Check the room resource/mailbox, licensing and sign-in state before resetting the room device.

### Rollback / undo
- Record meeting policy, room configuration and device state before change. Restore the previous approved policy/configuration if the change makes the room less functional.
