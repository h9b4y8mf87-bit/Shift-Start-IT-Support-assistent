...
description: Enterprise runbook to troubleshoot an application that crashes without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot an application that crashes, verify the original business task, and escalate with
