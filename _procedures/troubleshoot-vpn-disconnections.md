...
description: >-
  Enterprise runbook to troubleshoot vpn disconnections without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot vpn disconnections, verify the original business task, and escalate with complete logs if
