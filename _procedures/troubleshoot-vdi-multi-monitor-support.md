---
title: Troubleshoot VDI multi-monitor support
slug: troubleshoot-vdi-multi-monitor-support
description: 'Enterprise runbook to troubleshoot vdi multi-monitor support without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - vdi
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot vdi multi-monitor support, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - vdi-multi-monitor-support
  - remote-desktop-or-virtual-application-access-is-failing
symptom_weights:
  vdi-multi-monitor-support: 10
...
permalink: /procedures/troubleshoot-vdi-multi-monitor-support/
layout: article
