...
description: Enterprise runbook to prepare and validate a high-priority video conference without skipping evidence,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for prepare and validate a high-priority video conference, verify the original business task, and
