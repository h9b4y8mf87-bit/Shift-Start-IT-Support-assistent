...
description: >-
  Enterprise runbook to troubleshoot scan to network folder without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for troubleshoot scan to network folder, verify the original business task, and escalate with complete
