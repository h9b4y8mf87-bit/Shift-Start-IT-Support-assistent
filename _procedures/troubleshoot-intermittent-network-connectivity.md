...
description: >-
  Enterprise runbook to troubleshoot intermittent network connectivity without skipping evidence, verification, rollback
...
tldr: >-
  ...
  remediation for troubleshoot intermittent network connectivity, verify the original business task, and escalate with
