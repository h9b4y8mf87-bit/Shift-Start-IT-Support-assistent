...
description: Enterprise runbook to troubleshoot intermittent network connectivity without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot intermittent network connectivity, verify the original business task, and escalate
