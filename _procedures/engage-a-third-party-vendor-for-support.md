...
description: Enterprise runbook to engage a third-party vendor for support without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for engage a third-party vendor for support, verify the original business task, and escalate with
