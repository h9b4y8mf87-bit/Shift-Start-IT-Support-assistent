---
title: Engage a third-party vendor for support
slug: engage-a-third-party-vendor-for-support
description: Enterprise runbook to engage a third-party vendor for support without skipping evidence, verification, rollback or escalation requirements.
...
- vendor
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for engage a third-party vendor for support, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- need-to-engage-a-third-party-vendor-for-support
- support-request-requires-triage
- multiple-users-or-services-may-be-affected
symptom_weights:
  need-to-engage-a-third-party-vendor-for-support: 10
...
permalink: /procedures/engage-a-third-party-vendor-for-support/
layout: article
...
---
## Purpose and scope
Use this runbook for **engage a third-party vendor for support** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Confirm the exact condition described by “Engage a third-party vendor for support” and identify its first failing dependency.
...
The exact scenario “Engage a third-party vendor for support” is resolved and the original business task succeeds.
