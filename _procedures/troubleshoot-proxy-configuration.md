---
title: Troubleshoot proxy configuration
slug: troubleshoot-proxy-configuration
description: 'Enterprise runbook to troubleshoot proxy configuration without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot proxy configuration, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - proxy-configuration
  - network-or-internet-access-is-unavailable
  - connection-is-slow-or-intermittent
symptom_weights:
  proxy-configuration: 10
...
permalink: /procedures/troubleshoot-proxy-configuration/
layout: article
