...
description: Enterprise runbook to troubleshoot proxy configuration without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot proxy configuration, verify the original business task, and escalate with complete
