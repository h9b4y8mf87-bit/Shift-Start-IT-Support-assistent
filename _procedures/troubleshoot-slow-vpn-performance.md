...
description: >-
  Enterprise runbook to troubleshoot slow vpn performance without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for troubleshoot slow vpn performance, verify the original business task, and escalate with complete logs
