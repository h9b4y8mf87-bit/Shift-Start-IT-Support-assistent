...
description: >-
  Enterprise runbook to troubleshoot smart-card sign-in without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot smart-card sign-in, verify the original business task, and escalate with complete logs if
