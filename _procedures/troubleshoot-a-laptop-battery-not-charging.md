---
title: Troubleshoot a laptop battery not charging
slug: troubleshoot-a-laptop-battery-not-charging
description: 'Enterprise runbook to troubleshoot a laptop battery not charging without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - windows-endpoints
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot a laptop battery not charging, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - a-laptop-battery-not-charging
  - windows-device-is-not-working-correctly
  - a-windows-error-or-performance-issue-is-reported
symptom_weights:
  a-laptop-battery-not-charging: 10
...
permalink: /procedures/troubleshoot-a-laptop-battery-not-charging/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot a laptop battery not charging** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
