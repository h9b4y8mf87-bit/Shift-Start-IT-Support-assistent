---
title: Troubleshoot a captive portal
slug: troubleshoot-a-captive-portal
description: 'Enterprise runbook to troubleshoot a captive portal without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot a captive portal, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - a-captive-portal
...
permalink: /procedures/troubleshoot-a-captive-portal/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot a captive portal** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.

## Mandatory Batch B-1 controls
These audit-derived controls are mandatory before more invasive remediation.

### Pre-checks
1. Check captive-portal/NAC service health.
2. Check DNS/HTTP redirect path and portal certificate/URL reachability.
3. Check sponsor/guest approval workflow state where applicable.

### Rollback / undo
- Capture portal/NAC configuration before change and restore the previous known-good portal policy/theme/redirect configuration if the change breaks authentication.
