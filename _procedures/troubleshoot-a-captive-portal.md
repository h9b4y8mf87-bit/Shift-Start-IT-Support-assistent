...
description: >-
  Enterprise runbook to troubleshoot a captive portal without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot a captive portal, verify the original business task, and escalate with complete logs if
