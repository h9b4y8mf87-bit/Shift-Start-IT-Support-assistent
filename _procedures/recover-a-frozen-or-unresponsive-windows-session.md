...
description: Enterprise runbook to recover a frozen or unresponsive windows session without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for recover a frozen or unresponsive windows session, verify the original business task, and escalate
