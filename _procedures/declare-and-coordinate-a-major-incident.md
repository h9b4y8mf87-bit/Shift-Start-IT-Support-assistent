...
description: Enterprise runbook to declare and coordinate a major incident without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for declare and coordinate a major incident, verify the original business task, and escalate with
