...
description: Enterprise runbook to remove corporate data from a personal device without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for remove corporate data from a personal device, verify the original business task, and escalate
