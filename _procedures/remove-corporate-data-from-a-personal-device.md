...
description: >-
  Enterprise runbook to remove corporate data from a personal device without skipping evidence, verification, rollback
...
tldr: >-
  ...
  remediation for remove corporate data from a personal device, verify the original business task, and escalate with
