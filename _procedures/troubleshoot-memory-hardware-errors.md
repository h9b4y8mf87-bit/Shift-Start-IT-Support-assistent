...
description: Enterprise runbook to troubleshoot memory hardware errors without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot memory hardware errors, verify the original business task, and escalate with complete
