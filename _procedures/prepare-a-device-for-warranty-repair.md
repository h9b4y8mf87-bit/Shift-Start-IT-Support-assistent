---
title: Prepare a device for warranty repair
slug: prepare-a-device-for-warranty-repair
description: Enterprise runbook to prepare a device for warranty repair without skipping evidence, verification, rollback or escalation requirements.
...
- warranty
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for prepare a device for warranty repair, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- need-to-prepare-a-device-for-warranty-repair
- hardware-or-peripheral-is-not-functioning
symptom_weights:
  need-to-prepare-a-device-for-warranty-repair: 10
...
permalink: /procedures/prepare-a-device-for-warranty-repair/
layout: article
...
---
## Purpose and scope
Use this runbook for **prepare a device for warranty repair** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Confirm the exact condition described by “Prepare a device for warranty repair” and identify its first failing dependency.
...
The exact scenario “Prepare a device for warranty repair” is resolved and the original business task succeeds.
