...
description: Enterprise runbook to prepare a device for warranty repair without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for prepare a device for warranty repair, verify the original business task, and escalate with complete
