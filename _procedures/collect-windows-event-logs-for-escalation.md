...
description: Enterprise runbook to collect windows event logs for escalation without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for collect windows event logs for escalation, verify the original business task, and escalate with
