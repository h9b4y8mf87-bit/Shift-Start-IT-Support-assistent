---
title: Troubleshoot Teams calling
slug: troubleshoot-teams-calling
description: 'Enterprise runbook to troubleshoot teams calling without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot teams calling, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - teams-calling
...
permalink: /procedures/troubleshoot-teams-calling/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot teams calling** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.

## Mandatory Batch B-2 controls
These audit-derived controls are mandatory before more invasive remediation.

### Pre-checks
1. Check Microsoft 365 / Teams Phone service health before changing client or calling configuration.
2. Check licence/calling-plan assignment or Direct Routing/SBC health as applicable.
3. Capture call ID/time/user and call diagnostics/client logs before policy or SBC changes.

### Rollback / undo
- Record calling policy, routing and SBC configuration before change. Restore the previous approved policy/routing/SBC configuration if call establishment worsens.
