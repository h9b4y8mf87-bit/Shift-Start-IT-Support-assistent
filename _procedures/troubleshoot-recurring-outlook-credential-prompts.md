---
title: Troubleshoot recurring Outlook credential prompts
slug: troubleshoot-recurring-outlook-credential-prompts
description: 'Enterprise runbook to troubleshoot recurring outlook credential prompts without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot recurring outlook credential prompts, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - recurring-outlook-credential-prompts
  - microsoft-365-feature-is-not-working
  - cloud-collaboration-access-is-failing
symptom_weights:
  recurring-outlook-credential-prompts: 10
...
permalink: /procedures/troubleshoot-recurring-outlook-credential-prompts/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot recurring outlook credential prompts** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.

## Mandatory Batch B-2 controls
These audit-derived controls are mandatory before more invasive remediation.

### Pre-checks
1. Check identity/service health and account/MFA state before deleting cached credentials.
2. Check the authentication method and whether legacy/basic authentication is being attempted.
3. Inspect Credential Manager only for relevant stale entries; do not remove unrelated saved credentials.

### Rollback / undo
- Record relevant credential/cache changes. Restore policy/configuration only through the approved identity/Microsoft 365 configuration path; never restore a compromised or expired credential.
