...
description: Enterprise runbook to troubleshoot recurring outlook credential prompts without skipping evidence,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot recurring outlook credential prompts, verify the original business task, and escalate
