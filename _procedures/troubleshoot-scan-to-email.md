...
description: >-
  Enterprise runbook to troubleshoot scan to email without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot scan to email, verify the original business task, and escalate with complete logs if
