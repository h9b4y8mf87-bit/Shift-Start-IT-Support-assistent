...
description: Enterprise runbook to troubleshoot sleep, wake or hibernation without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot sleep, wake or hibernation, verify the original business task, and escalate with
