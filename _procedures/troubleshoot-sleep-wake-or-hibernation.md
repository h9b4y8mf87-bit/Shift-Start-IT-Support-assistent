---
title: 'Troubleshoot sleep, wake or hibernation'
slug: troubleshoot-sleep-wake-or-hibernation
description: 'Enterprise runbook to troubleshoot sleep, wake or hibernation without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - windows-endpoints
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot sleep, wake or hibernation, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - sleep-wake-or-hibernation
  - windows-device-is-not-working-correctly
  - a-windows-error-or-performance-issue-is-reported
symptom_weights:
  sleep-wake-or-hibernation: 10
...
permalink: /procedures/troubleshoot-sleep-wake-or-hibernation/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot sleep, wake or hibernation** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Confirm the exact condition described by “Troubleshoot sleep, wake or hibernation” and identify its first failing dependency.
...
The exact scenario “Troubleshoot sleep, wake or hibernation” is resolved and the original business task succeeds.
