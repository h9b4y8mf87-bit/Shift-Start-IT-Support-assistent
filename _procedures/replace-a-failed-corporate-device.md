...
description: >-
  Enterprise runbook to replace a failed corporate device without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for replace a failed corporate device, verify the original business task, and escalate with complete logs
