...
description: Enterprise runbook to replace a failed corporate device without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for replace a failed corporate device, verify the original business task, and escalate with complete
