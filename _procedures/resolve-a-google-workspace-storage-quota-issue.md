...
description: Enterprise runbook to resolve a google workspace storage quota issue without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for resolve a google workspace storage quota issue, verify the original business task, and escalate
