---
title: Troubleshoot colour or duplex printing
slug: troubleshoot-colour-or-duplex-printing
description: 'Enterprise runbook to troubleshoot colour or duplex printing without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot colour or duplex printing, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - colour-or-duplex-printing
  - printing-or-scanning-is-not-working
symptom_weights:
  colour-or-duplex-printing: 10
...
permalink: /procedures/troubleshoot-colour-or-duplex-printing/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot colour or duplex printing** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.

## Mandatory Batch B-5 controls
These audit-derived controls are mandatory before more invasive remediation.

### Pre-checks
1. Verify the printer driver supports colour/duplex (check the device capabilities).
2. Check the application's page setup and printer preferences.
3. Test from a different application to isolate driver vs. application settings.

### Rollback / undo
- If a driver update broke colour/duplex, roll back to the previous driver via Print Management.
