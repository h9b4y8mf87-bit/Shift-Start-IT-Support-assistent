...
description: Enterprise runbook to securely transfer large business files without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for securely transfer large business files, verify the original business task, and escalate with complete
