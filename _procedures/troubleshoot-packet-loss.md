---
title: Troubleshoot packet loss
slug: troubleshoot-packet-loss
description: 'Enterprise runbook to troubleshoot packet loss without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot packet loss, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - packet-loss
...
permalink: /procedures/troubleshoot-packet-loss/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot packet loss** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
