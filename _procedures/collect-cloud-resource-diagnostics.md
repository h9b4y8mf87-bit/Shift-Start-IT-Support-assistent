...
description: >-
  Enterprise runbook to collect cloud resource diagnostics without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for collect cloud resource diagnostics, verify the original business task, and escalate with complete logs
  if recovery is not achieved.
related_symptoms:
  - need-to-collect-cloud-resource-diagnostics
  - a-cloud-or-virtual-resource-is-degraded
symptom_weights:
  need-to-collect-cloud-resource-diagnostics: 10
