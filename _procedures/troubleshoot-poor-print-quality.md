...
description: >-
  Enterprise runbook to troubleshoot poor print quality without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot poor print quality, verify the original business task, and escalate with complete logs if
