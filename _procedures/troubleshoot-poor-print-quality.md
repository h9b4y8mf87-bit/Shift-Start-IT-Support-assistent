...
description: Enterprise runbook to troubleshoot poor print quality without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot poor print quality, verify the original business task, and escalate with complete
