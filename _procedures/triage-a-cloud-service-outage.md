---
title: Triage a cloud service outage
slug: triage-a-cloud-service-outage
description: 'Enterprise runbook to triage a cloud service outage without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - triage
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for triage a cloud service outage, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - a-cloud-service-outage
  - a-cloud-or-virtual-resource-is-degraded
symptom_weights:
  a-cloud-service-outage: 10
...
permalink: /procedures/triage-a-cloud-service-outage/
layout: article
