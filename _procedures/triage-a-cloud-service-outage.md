...
description: >-
  Enterprise runbook to triage a cloud service outage without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for triage a cloud service outage, verify the original business task, and escalate with complete logs if
