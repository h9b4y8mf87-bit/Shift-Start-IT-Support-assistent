...
description: Enterprise runbook to create a problem record from recurring incidents without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for create a problem record from recurring incidents, verify the original business task, and escalate
