---
title: Create a problem record from recurring incidents
slug: create-a-problem-record-from-recurring-incidents
description: Enterprise runbook to create a problem record from recurring incidents without skipping evidence, verification, rollback or escalation requirements.
...
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for create a problem record from recurring incidents, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- need-to-create-a-problem-record-from-recurring-incidents
- support-request-requires-triage
- multiple-users-or-services-may-be-affected
symptom_weights:
  need-to-create-a-problem-record-from-recurring-incidents: 10
...
permalink: /procedures/create-a-problem-record-from-recurring-incidents/
layout: article
...
### Targeted checks
- Confirm the exact condition described by “Create a problem record from recurring incidents” and identify its first failing dependency.
...
The exact scenario “Create a problem record from recurring incidents” is resolved and the original business task succeeds.
