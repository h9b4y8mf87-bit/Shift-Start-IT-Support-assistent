---
title: Resolve a Windows service that will not start
slug: resolve-a-windows-service-that-will-not-start
description: 'Enterprise runbook to resolve a windows service that will not start without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - windows-endpoints
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for resolve a windows service that will not start, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - a-windows-service-that-will-not-start
  - windows-device-is-not-working-correctly
  - a-windows-error-or-performance-issue-is-reported
symptom_weights:
  a-windows-service-that-will-not-start: 10
...
permalink: /procedures/resolve-a-windows-service-that-will-not-start/
layout: article
