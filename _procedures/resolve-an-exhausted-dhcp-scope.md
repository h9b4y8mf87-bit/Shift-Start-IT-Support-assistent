...
description: Enterprise runbook to resolve an exhausted dhcp scope without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for resolve an exhausted dhcp scope, verify the original business task, and escalate with complete
