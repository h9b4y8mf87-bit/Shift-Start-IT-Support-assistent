...
description: Enterprise runbook to report and contain a phishing email without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for report and contain a phishing email, verify the original business task, and escalate with complete
