...
description: 'Enterprise runbook to report and contain a phishing email without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - report
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for report and contain a phishing email, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - report-and-contain-a-phishing-email
  - microsoft-365-feature-is-not-working
  - cloud-collaboration-access-is-failing
symptom_weights:
  report-and-contain-a-phishing-email: 10
...
permalink: /procedures/report-and-contain-a-phishing-email/
layout: article
