---
title: Troubleshoot a SAML application error
slug: troubleshoot-a-saml-application-error
description: 'Enterprise runbook to troubleshoot a saml application error without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot a saml application error, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - a-saml-application-error
  - a-business-application-or-website-is-not-working
symptom_weights:
  a-saml-application-error: 10
...
permalink: /procedures/troubleshoot-a-saml-application-error/
layout: article
