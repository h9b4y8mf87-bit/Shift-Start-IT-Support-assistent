...
description: Enterprise runbook to troubleshoot a failed server backup without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a failed server backup, verify the original business task, and escalate with complete
