...
description: Enterprise runbook to provide secure remote support without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for provide secure remote support, verify the original business task, and escalate with complete logs
