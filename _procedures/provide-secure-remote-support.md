...
description: >-
  Enterprise runbook to provide secure remote support without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for provide secure remote support, verify the original business task, and escalate with complete logs if
