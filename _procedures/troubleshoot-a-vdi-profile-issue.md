...
description: Enterprise runbook to troubleshoot a vdi profile issue without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a vdi profile issue, verify the original business task, and escalate with complete
