...
description: Enterprise runbook to troubleshoot enterprise software deployment without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot enterprise software deployment, verify the original business task, and escalate with
