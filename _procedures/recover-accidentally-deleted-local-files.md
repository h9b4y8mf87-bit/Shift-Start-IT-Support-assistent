...
description: Enterprise runbook to recover accidentally deleted local files without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for recover accidentally deleted local files, verify the original business task, and escalate with
