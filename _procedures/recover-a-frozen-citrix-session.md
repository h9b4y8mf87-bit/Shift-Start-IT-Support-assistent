...
description: >-
  Enterprise runbook to recover a frozen citrix session without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for recover a frozen citrix session, verify the original business task, and escalate with complete logs if
