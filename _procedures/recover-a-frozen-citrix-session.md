---
title: Recover a frozen Citrix session
slug: recover-a-frozen-citrix-session
description: 'Enterprise runbook to recover a frozen citrix session without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - session
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for recover a frozen citrix session, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - a-frozen-citrix-session
  - remote-desktop-or-virtual-application-access-is-failing
symptom_weights:
  a-frozen-citrix-session: 10
...
permalink: /procedures/recover-a-frozen-citrix-session/
layout: article
...
---
## Purpose and scope
Use this runbook for **recover a frozen citrix session** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
