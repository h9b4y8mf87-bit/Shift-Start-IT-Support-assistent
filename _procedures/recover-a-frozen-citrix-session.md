...
description: Enterprise runbook to recover a frozen citrix session without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for recover a frozen citrix session, verify the original business task, and escalate with complete
