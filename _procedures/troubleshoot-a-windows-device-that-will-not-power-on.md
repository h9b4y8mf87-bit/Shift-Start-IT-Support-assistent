...
description: Enterprise runbook to troubleshoot a windows device that will not power on without skipping evidence,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a windows device that will not power on, verify the original business task, and escalate
