...
description: Enterprise runbook to troubleshoot chrome profile synchronisation without skipping evidence, verification,
...
approval_required: Follow organisational policy for privileged, destructive, security-sensitive or service-impacting
  actions.
permalink: /procedures/troubleshoot-chrome-profile-synchronisation/
layout: article
---
## Purpose and scope
