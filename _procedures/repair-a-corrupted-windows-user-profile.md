...
description: Enterprise runbook to repair a corrupted windows user profile without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for repair a corrupted windows user profile, verify the original business task, and escalate with
