---
title: Troubleshoot Power BI sign-in or access
slug: troubleshoot-power-bi-sign-in-or-access
description: 'Enterprise runbook to troubleshoot power bi sign-in or access without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot power bi sign-in or access, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - power-bi-sign-in-or-access
  - microsoft-365-feature-is-not-working
  - cloud-collaboration-access-is-failing
symptom_weights:
  power-bi-sign-in-or-access: 10
...
permalink: /procedures/troubleshoot-power-bi-sign-in-or-access/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot power bi sign-in or access** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Confirm the exact condition described by “Troubleshoot Power BI sign-in or access” and identify its first failing dependency.
...
The exact scenario “Troubleshoot Power BI sign-in or access” is resolved and the original business task succeeds.
