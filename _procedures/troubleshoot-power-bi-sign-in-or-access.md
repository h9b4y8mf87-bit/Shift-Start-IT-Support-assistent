...
description: Enterprise runbook to troubleshoot power bi sign-in or access without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot power bi sign-in or access, verify the original business task, and escalate with
