...
description: Enterprise runbook to troubleshoot cloud application authentication without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot cloud application authentication, verify the original business task, and escalate
