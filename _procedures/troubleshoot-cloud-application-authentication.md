---
title: Troubleshoot cloud application authentication
slug: troubleshoot-cloud-application-authentication
description: 'Enterprise runbook to troubleshoot cloud application authentication without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot cloud application authentication, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - cloud-application-authentication
  - a-cloud-or-virtual-resource-is-degraded
symptom_weights:
  cloud-application-authentication: 10
...
permalink: /procedures/troubleshoot-cloud-application-authentication/
layout: article
