...
description: >-
  Enterprise runbook to troubleshoot a webcam on windows without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot a webcam on windows, verify the original business task, and escalate with complete logs
