...
description: >-
  Enterprise runbook to troubleshoot an azure virtual desktop sign-in without skipping evidence, verification, rollback
...
tldr: >-
  ...
  remediation for troubleshoot an azure virtual desktop sign-in, verify the original business task, and escalate with
