...
description: Enterprise runbook to recover a deleted email without skipping evidence, verification, rollback or
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for recover a deleted email, verify the original business task, and escalate with complete logs if
