...
description: Enterprise runbook to collect business-application logs without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for collect business-application logs, verify the original business task, and escalate with complete
