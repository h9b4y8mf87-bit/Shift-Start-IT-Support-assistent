---
title: Collect business-application logs
slug: collect-business-application-logs
description: Enterprise runbook to collect business-application logs without skipping evidence, verification, rollback or escalation requirements.
...
- logs
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for collect business-application logs, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- need-to-collect-business-application-logs
- a-business-application-or-website-is-not-working
symptom_weights:
  need-to-collect-business-application-logs: 10
...
permalink: /procedures/collect-business-application-logs/
layout: article
...
---
## Purpose and scope
Use this runbook for **collect business-application logs** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Confirm the exact condition described by “Collect business-application logs” and identify its first failing dependency.
...
The exact scenario “Collect business-application logs” is resolved and the original business task succeeds.
