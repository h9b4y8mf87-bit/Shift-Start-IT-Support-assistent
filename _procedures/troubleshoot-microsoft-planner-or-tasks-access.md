...
description: Enterprise runbook to troubleshoot microsoft planner or tasks access without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot microsoft planner or tasks access, verify the original business task, and escalate
