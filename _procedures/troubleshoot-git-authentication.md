...
description: >-
  Enterprise runbook to troubleshoot git authentication without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot git authentication, verify the original business task, and escalate with complete logs if
