...
description: >-
  Enterprise runbook to troubleshoot user account control or admin-rights requests without skipping evidence,
...
tldr: >-
  ...
  remediation for troubleshoot user account control or admin-rights requests, verify the original business task, and
