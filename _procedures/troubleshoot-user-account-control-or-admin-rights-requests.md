...
description: Enterprise runbook to troubleshoot user account control or admin-rights requests without skipping evidence,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot user account control or admin-rights requests, verify the original business task,
  and escalate with complete logs if recovery is not achieved.
related_symptoms:
