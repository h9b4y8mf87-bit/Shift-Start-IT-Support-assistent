---
title: Troubleshoot User Account Control or admin-rights requests
slug: troubleshoot-user-account-control-or-admin-rights-requests
description: 'Enterprise runbook to troubleshoot user account control or admin-rights requests without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - windows-endpoints
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot user account control or admin-rights requests, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - user-account-control-or-admin-rights-requests
  - windows-device-is-not-working-correctly
  - a-windows-error-or-performance-issue-is-reported
symptom_weights:
  user-account-control-or-admin-rights-requests: 10
...
permalink: /procedures/troubleshoot-user-account-control-or-admin-rights-requests/
layout: article
...
### Targeted checks
- Confirm the exact condition described by “Troubleshoot User Account Control or admin-rights requests” and identify its first failing dependency.
...
The exact scenario “Troubleshoot User Account Control or admin-rights requests” is resolved and the original business task succeeds.
