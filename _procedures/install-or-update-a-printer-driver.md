...
description: >-
  Enterprise runbook to install or update a printer driver without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for install or update a printer driver, verify the original business task, and escalate with complete logs
