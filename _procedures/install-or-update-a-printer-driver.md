---
title: Install or update a printer driver
slug: install-or-update-a-printer-driver
description: Enterprise runbook to install or update a printer driver without skipping evidence, verification, rollback or escalation requirements.
...
- update
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for install or update a printer driver, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- need-to-install-or-update-a-printer-driver
- printing-or-scanning-is-not-working
symptom_weights:
  need-to-install-or-update-a-printer-driver: 10
...
permalink: /procedures/install-or-update-a-printer-driver/
layout: article
