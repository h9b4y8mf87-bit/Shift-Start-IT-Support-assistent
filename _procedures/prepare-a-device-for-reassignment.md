...
description: >-
  Enterprise runbook to prepare a device for reassignment without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for prepare a device for reassignment, verify the original business task, and escalate with complete logs
