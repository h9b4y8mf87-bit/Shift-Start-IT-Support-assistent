...
description: Enterprise runbook to prepare a device for reassignment without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for prepare a device for reassignment, verify the original business task, and escalate with complete
