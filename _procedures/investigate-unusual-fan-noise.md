...
description: Enterprise runbook to investigate unusual fan noise without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for investigate unusual fan noise, verify the original business task, and escalate with complete logs
