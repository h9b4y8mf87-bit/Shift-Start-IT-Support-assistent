---
title: Troubleshoot Remote Desktop connection failure
slug: troubleshoot-remote-desktop-connection-failure
description: 'Enterprise runbook to troubleshoot remote desktop connection failure without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - windows-endpoints
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot remote desktop connection failure, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - remote-desktop-connection-failure
  - windows-device-is-not-working-correctly
  - a-windows-error-or-performance-issue-is-reported
symptom_weights:
  remote-desktop-connection-failure: 10
...
permalink: /procedures/troubleshoot-remote-desktop-connection-failure/
layout: article
...
### Targeted checks
- Confirm the exact condition described by “Troubleshoot Remote Desktop connection failure” and identify its first failing dependency.
