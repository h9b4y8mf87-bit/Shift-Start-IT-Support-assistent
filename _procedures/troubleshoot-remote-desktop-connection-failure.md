...
description: Enterprise runbook to troubleshoot remote desktop connection failure without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot remote desktop connection failure, verify the original business task, and escalate
