...
description: Enterprise runbook to respond to an impossible-travel alert without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for respond to an impossible-travel alert, verify the original business task, and escalate with complete
