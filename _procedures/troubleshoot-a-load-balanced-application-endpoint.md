...
description: >-
  Enterprise runbook to troubleshoot a load-balanced application endpoint without skipping evidence, verification,
...
tldr: >-
  ...
  remediation for troubleshoot a load-balanced application endpoint, verify the original business task, and escalate
