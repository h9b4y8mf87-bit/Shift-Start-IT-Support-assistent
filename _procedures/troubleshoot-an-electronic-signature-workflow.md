...
description: Enterprise runbook to troubleshoot an electronic-signature workflow without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot an electronic-signature workflow, verify the original business task, and escalate
