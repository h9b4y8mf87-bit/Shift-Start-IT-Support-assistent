...
description: >-
  Enterprise runbook to troubleshoot an electronic-signature workflow without skipping evidence, verification, rollback
...
tldr: >-
  ...
  remediation for troubleshoot an electronic-signature workflow, verify the original business task, and escalate with
