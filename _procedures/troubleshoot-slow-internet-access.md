---
title: Troubleshoot slow internet access
slug: troubleshoot-slow-internet-access
description: 'Enterprise runbook to troubleshoot slow internet access without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot slow internet access, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - slow-internet-access
  - network-or-internet-access-is-unavailable
  - connection-is-slow-or-intermittent
symptom_weights:
  slow-internet-access: 10
...
permalink: /procedures/troubleshoot-slow-internet-access/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot slow internet access** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.

## Mandatory Batch B-2 controls
These audit-derived controls are mandatory before more invasive remediation.

### Pre-checks
1. Determine whether the slowdown is one endpoint, one VLAN/site or provider-wide before treating it as infrastructure.
2. Check WAN utilisation, loss/latency and provider circuit health.
3. Check QoS/traffic-shaping and recent WAN/firewall changes.

### Rollback / undo
- Capture QoS, traffic-shaping and WAN-routing state before change. Restore the previous known-good configuration or approved failback path if performance worsens.
