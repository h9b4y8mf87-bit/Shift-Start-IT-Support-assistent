...
description: >-
  Enterprise runbook to troubleshoot slow internet access without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for troubleshoot slow internet access, verify the original business task, and escalate with complete logs
