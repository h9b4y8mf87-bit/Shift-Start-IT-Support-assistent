...
canonical_procedure: troubleshoot-high-cpu-utilisation
deprecation_reason: Merged into troubleshoot-high-cpu-utilisation during Batch B-6 audit.
---
## Deprecated — use the canonical procedure
This page has been consolidated into `troubleshoot-high-cpu-utilisation`.

Use `/procedures/troubleshoot-high-cpu-utilisation/`.
