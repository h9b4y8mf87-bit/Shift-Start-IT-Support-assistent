...
description: Enterprise runbook to troubleshoot server high cpu without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot server high cpu, verify the original business task, and escalate with complete logs
