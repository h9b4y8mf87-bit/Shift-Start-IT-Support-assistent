...
description: >-
  Enterprise runbook to troubleshoot server high cpu without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot server high cpu, verify the original business task, and escalate with complete logs if
