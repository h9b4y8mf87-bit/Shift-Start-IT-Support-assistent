...
description: Enterprise runbook to troubleshoot a cloud vpn gateway without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a cloud vpn gateway, verify the original business task, and escalate with complete
