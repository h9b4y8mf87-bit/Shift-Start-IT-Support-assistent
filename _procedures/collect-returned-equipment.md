...
description: Enterprise runbook to collect returned equipment without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for collect returned equipment, verify the original business task, and escalate with complete logs
