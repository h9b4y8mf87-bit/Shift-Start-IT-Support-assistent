...
description: >-
  Enterprise runbook to collect returned equipment without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for collect returned equipment, verify the original business task, and escalate with complete logs if
