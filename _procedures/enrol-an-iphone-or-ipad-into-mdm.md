...
description: Enterprise runbook to enrol an iphone or ipad into mdm without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for enrol an iphone or ipad into mdm, verify the original business task, and escalate with complete
