...
description: >-
  Enterprise runbook to enrol an iphone or ipad into mdm without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for enrol an iphone or ipad into mdm, verify the original business task, and escalate with complete logs
