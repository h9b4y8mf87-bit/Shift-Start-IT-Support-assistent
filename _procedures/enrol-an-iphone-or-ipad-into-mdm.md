...
description: 'Enterprise runbook to enrol an iphone or ipad into mdm without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - or
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for enrol an iphone or ipad into mdm, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - enrol-an-iphone-or-ipad-into-mdm
  - corporate-access-on-a-mobile-device-is-not-working
  - mobile-device-is-not-compliant
symptom_weights:
  enrol-an-iphone-or-ipad-into-mdm: 10
...
permalink: /procedures/enrol-an-iphone-or-ipad-into-mdm/
layout: article
...
---
## Purpose and scope
Use this runbook for **enrol an iphone or ipad into mdm** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
