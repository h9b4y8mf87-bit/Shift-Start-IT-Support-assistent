...
description: Enterprise runbook to verify caller identity before support without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for verify caller identity before support, verify the original business task, and escalate with complete
