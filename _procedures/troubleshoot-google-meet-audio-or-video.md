...
description: Enterprise runbook to troubleshoot google meet audio or video without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot google meet audio or video, verify the original business task, and escalate with
