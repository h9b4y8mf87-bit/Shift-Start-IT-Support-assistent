...
description: >-
  Enterprise runbook to troubleshoot sharepoint access without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot sharepoint access, verify the original business task, and escalate with complete logs if
