...
description: >-
  Enterprise runbook to troubleshoot a room mailbox without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot a room mailbox, verify the original business task, and escalate with complete logs if
