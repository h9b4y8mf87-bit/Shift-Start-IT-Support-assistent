---
title: Troubleshoot a room mailbox
slug: troubleshoot-a-room-mailbox
description: 'Enterprise runbook to troubleshoot a room mailbox without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot a room mailbox, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - a-room-mailbox
...
permalink: /procedures/troubleshoot-a-room-mailbox/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot a room mailbox** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.

## Mandatory Batch B-4 controls
These audit-derived controls are mandatory before more invasive remediation.

### Pre-checks
1. Check the room mailbox's calendar processing settings (auto-accept/decline).
2. Verify the room resource is not double-booked or overbooked.
3. Confirm the room's delegate/owner permissions.

### Rollback / undo
- If a calendar processing rule change broke booking, revert the rule to the previous state via Exchange Admin Center.
