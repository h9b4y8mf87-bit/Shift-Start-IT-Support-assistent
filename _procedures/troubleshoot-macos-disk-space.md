...
description: >-
  Enterprise runbook to troubleshoot macos disk space without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot macos disk space, verify the original business task, and escalate with complete logs if
