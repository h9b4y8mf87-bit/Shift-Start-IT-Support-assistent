...
description: Enterprise runbook to troubleshoot an external monitor with no signal without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot an external monitor with no signal, verify the original business task, and escalate
