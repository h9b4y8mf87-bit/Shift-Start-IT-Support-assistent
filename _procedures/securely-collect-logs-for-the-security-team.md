...
description: >-
  Enterprise runbook to securely collect logs for the security team without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for securely collect logs for the security team, verify the original business task, and escalate with
