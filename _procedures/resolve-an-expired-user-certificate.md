...
description: Enterprise runbook to resolve an expired user certificate without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for resolve an expired user certificate, verify the original business task, and escalate with complete
