...
description: Enterprise runbook to triage a site internet outage without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for triage a site internet outage, verify the original business task, and escalate with complete logs
...
The exact scenario “Triage a site internet outage” is resolved and the original business task succeeds.
