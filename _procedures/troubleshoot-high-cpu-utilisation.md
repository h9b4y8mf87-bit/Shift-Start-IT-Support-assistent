...
description: Enterprise runbook to troubleshoot high cpu utilisation without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot high cpu utilisation, verify the original business task, and escalate with complete
