...
description: Enterprise runbook to repair a corrupted outlook data cache without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for repair a corrupted outlook data cache, verify the original business task, and escalate with complete
