...
description: >-
  Enterprise runbook to respond to a ransomware alert without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for respond to a ransomware alert, verify the original business task, and escalate with complete logs if
