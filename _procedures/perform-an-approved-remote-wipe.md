...
description: Enterprise runbook to perform an approved remote wipe without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for perform an approved remote wipe, verify the original business task, and escalate with complete
