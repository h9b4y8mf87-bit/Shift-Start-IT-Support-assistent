...
description: >-
  Enterprise runbook to perform an approved remote wipe without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for perform an approved remote wipe, verify the original business task, and escalate with complete logs if
