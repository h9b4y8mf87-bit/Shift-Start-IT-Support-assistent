...
description: Enterprise runbook to troubleshoot sharepoint document synchronisation without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot sharepoint document synchronisation, verify the original business task, and escalate
