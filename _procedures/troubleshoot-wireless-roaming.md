...
description: Enterprise runbook to troubleshoot wireless roaming without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot wireless roaming, verify the original business task, and escalate with complete logs
