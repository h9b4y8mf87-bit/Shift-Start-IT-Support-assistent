...
description: Enterprise runbook to troubleshoot a legacy application compatibility issue without skipping evidence,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a legacy application compatibility issue, verify the original business task, and
