...
description: >-
  Enterprise runbook to troubleshoot a legacy application compatibility issue without skipping evidence, verification,
...
tldr: >-
  ...
  remediation for troubleshoot a legacy application compatibility issue, verify the original business task, and escalate
