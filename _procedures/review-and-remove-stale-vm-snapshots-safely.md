...
description: Enterprise runbook to review and remove stale vm snapshots safely without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for review and remove stale vm snapshots safely, verify the original business task, and escalate with
