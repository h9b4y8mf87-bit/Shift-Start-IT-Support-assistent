...
description: >-
  Enterprise runbook to triage a dhcp service issue without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for triage a dhcp service issue, verify the original business task, and escalate with complete logs if
