...
description: >-
  Enterprise runbook to troubleshoot a developer ide without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot a developer ide, verify the original business task, and escalate with complete logs if
