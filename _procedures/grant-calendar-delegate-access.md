...
description: >-
  Enterprise runbook to grant calendar delegate access without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for grant calendar delegate access, verify the original business task, and escalate with complete logs if
