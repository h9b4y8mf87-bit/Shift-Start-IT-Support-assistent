...
description: >-
  Enterprise runbook to provision external guest access without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for provision external guest access, verify the original business task, and escalate with complete logs if
