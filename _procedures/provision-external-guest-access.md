...
description: Enterprise runbook to provision external guest access without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for provision external guest access, verify the original business task, and escalate with complete
