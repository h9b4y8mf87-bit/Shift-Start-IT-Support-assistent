---
title: Troubleshoot a failed mouse or pointing device
slug: troubleshoot-a-failed-mouse-or-pointing-device
description: Enterprise runbook to troubleshoot a failed mouse or pointing device without skipping evidence, verification, rollback or escalation requirements.
...
- troubleshoot
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot a failed mouse or pointing device, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- a-failed-mouse-or-pointing-device
- hardware-or-peripheral-is-not-functioning
symptom_weights:
  a-failed-mouse-or-pointing-device: 10
...
permalink: /procedures/troubleshoot-a-failed-mouse-or-pointing-device/
layout: article
