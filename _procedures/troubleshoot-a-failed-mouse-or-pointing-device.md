...
description: >-
  Enterprise runbook to troubleshoot a failed mouse or pointing device without skipping evidence, verification, rollback
...
tldr: >-
  ...
  remediation for troubleshoot a failed mouse or pointing device, verify the original business task, and escalate with
