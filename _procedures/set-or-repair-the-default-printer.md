...
description: Enterprise runbook to set or repair the default printer without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for set or repair the default printer, verify the original business task, and escalate with complete
