...
description: Enterprise runbook to check domain controller health without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for check domain controller health, verify the original business task, and escalate with complete
