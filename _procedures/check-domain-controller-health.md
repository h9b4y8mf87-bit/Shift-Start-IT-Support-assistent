...
description: >-
  Enterprise runbook to check domain controller health without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for check domain controller health, verify the original business task, and escalate with complete logs if
