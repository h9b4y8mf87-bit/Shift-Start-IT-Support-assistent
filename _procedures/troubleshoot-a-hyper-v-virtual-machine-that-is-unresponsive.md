...
description: Enterprise runbook to troubleshoot a hyper-v virtual machine that is unresponsive without skipping
  evidence, verification, rollback or escalation requirements.
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a hyper-v virtual machine that is unresponsive, verify the original business task,
