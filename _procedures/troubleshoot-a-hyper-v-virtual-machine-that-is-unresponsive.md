...
description: >-
  Enterprise runbook to troubleshoot a hyper-v virtual machine that is unresponsive without skipping evidence,
...
tldr: >-
  ...
  remediation for troubleshoot a hyper-v virtual machine that is unresponsive, verify the original business task, and
