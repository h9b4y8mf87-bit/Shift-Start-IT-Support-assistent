...
description: Enterprise runbook to troubleshoot gmail send or receive without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot gmail send or receive, verify the original business task, and escalate with complete
