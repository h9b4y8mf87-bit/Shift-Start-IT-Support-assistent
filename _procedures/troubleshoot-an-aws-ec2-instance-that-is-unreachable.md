---
title: Troubleshoot an AWS EC2 instance that is unreachable
slug: troubleshoot-an-aws-ec2-instance-that-is-unreachable
description: 'Enterprise runbook to troubleshoot an aws ec2 instance that is unreachable without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - unreachable
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot an aws ec2 instance that is unreachable, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - an-aws-ec2-instance-that-is-unreachable
  - a-cloud-or-virtual-resource-is-degraded
symptom_weights:
  an-aws-ec2-instance-that-is-unreachable: 10
...
permalink: /procedures/troubleshoot-an-aws-ec2-instance-that-is-unreachable/
layout: article
