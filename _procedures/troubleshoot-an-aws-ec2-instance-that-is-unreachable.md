...
description: >-
  Enterprise runbook to troubleshoot an aws ec2 instance that is unreachable without skipping evidence, verification,
...
tldr: >-
  ...
  remediation for troubleshoot an aws ec2 instance that is unreachable, verify the original business task, and escalate
