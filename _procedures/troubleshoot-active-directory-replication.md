---
title: Troubleshoot Active Directory replication
slug: troubleshoot-active-directory-replication
description: Enterprise runbook to troubleshoot active directory replication without skipping evidence, verification, rollback or escalation requirements.
...
- troubleshoot
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot active directory replication, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- active-directory-replication
- a-server-or-infrastructure-service-is-degraded
symptom_weights:
  active-directory-replication: 10
...
permalink: /procedures/troubleshoot-active-directory-replication/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot active directory replication** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
