...
description: >-
  Enterprise runbook to deprovision a departing user account without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for deprovision a departing user account, verify the original business task, and escalate with complete
