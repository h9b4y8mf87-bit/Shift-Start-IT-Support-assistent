...
description: 'Enterprise runbook to deprovision a departing user account without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - user
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for deprovision a departing user account, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - deprovision-a-departing-user-account
  - cannot-sign-in
  - access-is-denied-or-missing
symptom_weights:
  deprovision-a-departing-user-account: 10
  cannot-sign-in: 3
...
permalink: /procedures/deprovision-a-departing-user-account/
layout: article
