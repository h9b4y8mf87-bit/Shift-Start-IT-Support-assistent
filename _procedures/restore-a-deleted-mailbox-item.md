---
title: Restore a deleted mailbox item
slug: restore-a-deleted-mailbox-item
description: 'Enterprise runbook to restore a deleted mailbox item without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - restore
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for restore a deleted mailbox item, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - a-deleted-mailbox-item
  - business-data-is-missing-corrupted-or-requires-recovery
symptom_weights:
  a-deleted-mailbox-item: 10
...
permalink: /procedures/restore-a-deleted-mailbox-item/
layout: article
...
---
## Purpose and scope
Use this runbook for **restore a deleted mailbox item** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
