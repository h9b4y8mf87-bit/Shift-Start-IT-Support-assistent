...
description: Enterprise runbook to restore a deleted mailbox item without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for restore a deleted mailbox item, verify the original business task, and escalate with complete
