...
description: >-
  Enterprise runbook to restore a deleted mailbox item without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for restore a deleted mailbox item, verify the original business task, and escalate with complete logs if
