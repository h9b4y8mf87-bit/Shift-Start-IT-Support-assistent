...
description: Enterprise runbook to resolve a paper jam safely without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for resolve a paper jam safely, verify the original business task, and escalate with complete logs
