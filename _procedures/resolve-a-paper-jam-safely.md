...
description: >-
  Enterprise runbook to resolve a paper jam safely without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for resolve a paper jam safely, verify the original business task, and escalate with complete logs if
