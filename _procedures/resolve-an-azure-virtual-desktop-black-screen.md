---
title: Resolve an Azure Virtual Desktop black screen
slug: resolve-an-azure-virtual-desktop-black-screen
description: Enterprise runbook to resolve an azure virtual desktop black screen without skipping evidence, verification, rollback or escalation requirements.
...
- virtual
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for resolve an azure virtual desktop black screen, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- an-azure-virtual-desktop-black-screen
- remote-desktop-or-virtual-application-access-is-failing
symptom_weights:
  an-azure-virtual-desktop-black-screen: 10
...
permalink: /procedures/resolve-an-azure-virtual-desktop-black-screen/
layout: article
