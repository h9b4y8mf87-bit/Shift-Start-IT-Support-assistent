...
description: Enterprise runbook to resolve an azure virtual desktop black screen without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for resolve an azure virtual desktop black screen, verify the original business task, and escalate
