...
description: Enterprise runbook to respond to unauthorised software without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for respond to unauthorised software, verify the original business task, and escalate with complete
