---
title: Respond to unauthorised software
slug: respond-to-unauthorised-software
description: 'Enterprise runbook to respond to unauthorised software without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - unauthorised
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for respond to unauthorised software, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - reported-unauthorised-software
  - a-security-or-compliance-concern-is-reported
symptom_weights:
  reported-unauthorised-software: 10
...
permalink: /procedures/respond-to-unauthorised-software/
layout: article
...
---
## Purpose and scope
Use this runbook for **respond to unauthorised software** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Confirm the exact condition described by “Respond to unauthorised software” and identify its first failing dependency.
...
The exact scenario “Respond to unauthorised software” is resolved and the original business task succeeds.
