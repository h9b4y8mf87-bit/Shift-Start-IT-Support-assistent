...
description: >-
  Enterprise runbook to troubleshoot network latency without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot network latency, verify the original business task, and escalate with complete logs if
