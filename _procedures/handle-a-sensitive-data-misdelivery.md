...
description: Enterprise runbook to handle a sensitive-data misdelivery without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for handle a sensitive-data misdelivery, verify the original business task, and escalate with complete
