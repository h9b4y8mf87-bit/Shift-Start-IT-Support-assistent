...
description: Enterprise runbook to troubleshoot a windows file share without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a windows file share, verify the original business task, and escalate with complete
