...
description: >-
  Enterprise runbook to resolve a patch compliance failure without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for resolve a patch compliance failure, verify the original business task, and escalate with complete logs
