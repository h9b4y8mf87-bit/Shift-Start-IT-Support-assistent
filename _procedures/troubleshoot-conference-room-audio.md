...
description: Enterprise runbook to troubleshoot conference-room audio without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot conference-room audio, verify the original business task, and escalate with complete
