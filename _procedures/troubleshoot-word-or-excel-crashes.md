...
description: Enterprise runbook to troubleshoot word or excel crashes without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot word or excel crashes, verify the original business task, and escalate with complete
