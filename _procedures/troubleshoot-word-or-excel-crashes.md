---
title: Troubleshoot Word or Excel crashes
slug: troubleshoot-word-or-excel-crashes
description: 'Enterprise runbook to troubleshoot word or excel crashes without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - word
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot word or excel crashes, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - word-or-excel-crashes
  - microsoft-365-feature-is-not-working
  - cloud-collaboration-access-is-failing
symptom_weights:
  word-or-excel-crashes: 10
...
permalink: /procedures/troubleshoot-word-or-excel-crashes/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot word or excel crashes** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
