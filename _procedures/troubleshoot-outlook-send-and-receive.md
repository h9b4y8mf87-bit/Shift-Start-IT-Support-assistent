---
title: Troubleshoot Outlook send and receive
slug: troubleshoot-outlook-send-and-receive
description: 'Enterprise runbook to troubleshoot outlook send and receive without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot outlook send and receive, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - outlook-send-and-receive
  - microsoft-365-feature-is-not-working
  - cloud-collaboration-access-is-failing
symptom_weights:
  outlook-send-and-receive: 10
...
permalink: /procedures/troubleshoot-outlook-send-and-receive/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot outlook send and receive** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.

## Mandatory Batch B-2 controls
These audit-derived controls are mandatory before more invasive remediation.

### Pre-checks
1. Test send/receive in Outlook on the web to confirm mailbox/service health.
2. Check mailbox quota, message-size limits and whether Outlook is working offline.
3. Check exact send/receive error, account state and network path before recreating a profile.

### Rollback / undo
- Record the current client/profile/update state before change. Revert only the specific approved client/update/configuration change that caused regression; preserve mailbox data.
