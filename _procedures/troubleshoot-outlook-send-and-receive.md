...
description: Enterprise runbook to troubleshoot outlook send and receive without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot outlook send and receive, verify the original business task, and escalate with complete
