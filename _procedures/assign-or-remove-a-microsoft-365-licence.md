...
description: Enterprise runbook to assign or remove a microsoft 365 licence without skipping evidence, verification,
...
approval_required: Follow organisational policy for privileged, destructive, security-sensitive or service-impacting
  actions.
permalink: /procedures/assign-or-remove-a-microsoft-365-licence/
layout: article
---
## Purpose and scope
...
### Targeted checks
- Check available subscription capacity, usage location, service-plan conflicts and group-based assignment.
- Compare the user with the approved licence persona.

### Targeted remediation sequence
1. Assign or remove the approved licence source and avoid duplicate direct/group assignments.
2. Wait for service provisioning and verify each required service plan.

### Scenario-specific success criterion
The correct service plans are provisioned without consuming an unintended licence.
