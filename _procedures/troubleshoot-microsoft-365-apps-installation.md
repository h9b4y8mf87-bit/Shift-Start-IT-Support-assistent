...
description: Enterprise runbook to troubleshoot microsoft 365 apps installation without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot microsoft 365 apps installation, verify the original business task, and escalate
