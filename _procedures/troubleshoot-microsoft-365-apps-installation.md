...
description: >-
  Enterprise runbook to troubleshoot microsoft 365 apps installation without skipping evidence, verification, rollback
...
tldr: >-
  ...
  remediation for troubleshoot microsoft 365 apps installation, verify the original business task, and escalate with
