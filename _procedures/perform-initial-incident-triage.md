...
description: >-
  Enterprise runbook to perform initial incident triage without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for perform initial incident triage, verify the original business task, and escalate with complete logs if
