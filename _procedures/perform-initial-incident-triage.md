...
description: Enterprise runbook to perform initial incident triage without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for perform initial incident triage, verify the original business task, and escalate with complete
