...
description: Enterprise runbook to resolve low virtualisation datastore capacity without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for resolve low virtualisation datastore capacity, verify the original business task, and escalate
