---
title: Resolve low virtualisation datastore capacity
slug: resolve-low-virtualisation-datastore-capacity
description: Enterprise runbook to resolve low virtualisation datastore capacity without skipping evidence, verification, rollback or escalation requirements.
...
- virtualisation
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for resolve low virtualisation datastore capacity, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- low-virtualisation-datastore-capacity
- a-cloud-or-virtual-resource-is-degraded
symptom_weights:
  low-virtualisation-datastore-capacity: 10
...
permalink: /procedures/resolve-low-virtualisation-datastore-capacity/
layout: article
