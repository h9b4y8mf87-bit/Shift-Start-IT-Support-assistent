...
description: >-
  Enterprise runbook to resolve low virtualisation datastore capacity without skipping evidence, verification, rollback
...
tldr: >-
  ...
  remediation for resolve low virtualisation datastore capacity, verify the original business task, and escalate with
