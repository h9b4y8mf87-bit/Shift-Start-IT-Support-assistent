---
title: Troubleshoot an HTTP 404 error
slug: troubleshoot-an-http-404-error
description: 'Enterprise runbook to troubleshoot an http 404 error without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot an http 404 error, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - an-http-404-error
  - a-business-application-or-website-is-not-working
symptom_weights:
  an-http-404-error: 10
...
permalink: /procedures/troubleshoot-an-http-404-error/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot an http 404 error** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.

## Mandatory Batch B-5 controls
These audit-derived controls are mandatory before more invasive remediation.

### Pre-checks
1. Verify the URL is entered correctly (typo, case sensitivity).
2. Check if the resource/page has been moved or renamed (confirm with the application owner).
3. Test the URL from a different browser/incognito and different user to determine scope.

### Rollback / undo
- If the page was mistakenly moved or deleted, restore it from backup or revert the web.config redirect rule.
