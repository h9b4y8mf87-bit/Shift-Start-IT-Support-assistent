...
description: Enterprise runbook to troubleshoot no ethernet connectivity without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot no ethernet connectivity, verify the original business task, and escalate with complete
