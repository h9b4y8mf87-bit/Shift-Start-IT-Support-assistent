...
description: >-
  Enterprise runbook to install or renew a mobile certificate without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for install or renew a mobile certificate, verify the original business task, and escalate with complete
