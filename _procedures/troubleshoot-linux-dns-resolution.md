...
description: Enterprise runbook to troubleshoot linux dns resolution without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot linux dns resolution, verify the original business task, and escalate with complete
