...
description: >-
  Enterprise runbook to troubleshoot an application access-denied error without skipping evidence, verification,
...
tldr: >-
  ...
  remediation for troubleshoot an application access-denied error, verify the original business task, and escalate with
