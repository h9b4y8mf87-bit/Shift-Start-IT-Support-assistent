...
description: Enterprise runbook to troubleshoot an application access-denied error without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot an application access-denied error, verify the original business task, and escalate
