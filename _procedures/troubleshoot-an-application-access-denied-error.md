---
title: Troubleshoot an application access-denied error
slug: troubleshoot-an-application-access-denied-error
description: Enterprise runbook to troubleshoot an application access-denied error without skipping evidence, verification, rollback or escalation requirements.
...
- troubleshoot
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot an application access-denied error, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- an-application-access-denied-error
- a-business-application-or-website-is-not-working
symptom_weights:
  an-application-access-denied-error: 10
...
permalink: /procedures/troubleshoot-an-application-access-denied-error/
layout: article
