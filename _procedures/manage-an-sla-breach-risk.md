...
description: Enterprise runbook to manage an sla breach risk without skipping evidence, verification, rollback or
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for manage an sla breach risk, verify the original business task, and escalate with complete logs
