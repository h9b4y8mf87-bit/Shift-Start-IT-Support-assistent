...
description: Enterprise runbook to troubleshoot calendar permissions without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot calendar permissions, verify the original business task, and escalate with complete
