...
description: >-
  Enterprise runbook to triage a web server http 503 error without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for triage a web server http 503 error, verify the original business task, and escalate with complete logs
