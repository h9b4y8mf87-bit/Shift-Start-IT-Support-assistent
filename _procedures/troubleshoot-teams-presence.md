---
title: Troubleshoot Teams presence
slug: troubleshoot-teams-presence
description: 'Enterprise runbook to troubleshoot teams presence without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot teams presence, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - teams-presence
...
permalink: /procedures/troubleshoot-teams-presence/
layout: article
...
risk_basis: 'Batch B-2 audit classification: P3 / low.'
...
---
## Purpose and scope
Use this runbook for **troubleshoot teams presence** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.

## Mandatory Batch B-2 controls
These audit-derived controls are mandatory before more invasive remediation.

### Pre-checks
1. Check Teams/Exchange service health and mailbox/calendar connectivity.
2. Check whether the user manually set a presence state and whether it is expected to expire.
3. Compare web/client presence before clearing local cache.

### Rollback / undo
- Cache regeneration normally has no meaningful state rollback. Preserve user data and avoid mailbox/calendar deletion; restore the previous client configuration if a configuration change caused the issue.
