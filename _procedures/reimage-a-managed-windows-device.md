...
description: >-
  Enterprise runbook to reimage a managed windows device without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for reimage a managed windows device, verify the original business task, and escalate with complete logs
