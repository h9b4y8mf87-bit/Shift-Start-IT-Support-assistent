...
description: Enterprise runbook to reimage a managed windows device without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for reimage a managed windows device, verify the original business task, and escalate with complete
