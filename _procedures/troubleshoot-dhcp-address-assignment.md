...
description: Enterprise runbook to troubleshoot dhcp address assignment without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot dhcp address assignment, verify the original business task, and escalate with complete
