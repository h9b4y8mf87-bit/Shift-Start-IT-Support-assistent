---
title: Process a vendor RMA
slug: process-a-vendor-rma
description: 'Enterprise runbook to process a vendor rma without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - vendor
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for process a vendor rma, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - request-to-a-vendor-rma
  - hardware-or-peripheral-is-not-functioning
symptom_weights:
  request-to-a-vendor-rma: 10
...
permalink: /procedures/process-a-vendor-rma/
layout: article
...
---
## Purpose and scope
Use this runbook for **process a vendor rma** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Confirm the exact condition described by “Process a vendor RMA” and identify its first failing dependency.
...
The exact scenario “Process a vendor RMA” is resolved and the original business task succeeds.
