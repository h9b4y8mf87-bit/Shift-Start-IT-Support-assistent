---
title: Assess storage drive health
slug: assess-storage-drive-health
description: 'Enterprise runbook to assess storage drive health without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - windows-endpoints
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for assess storage drive health, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - need-to-assess-storage-drive-health
  - windows-device-is-not-working-correctly
  - a-windows-error-or-performance-issue-is-reported
symptom_weights:
  need-to-assess-storage-drive-health: 10
...
permalink: /procedures/assess-storage-drive-health/
layout: article
...
---
## Purpose and scope
Use this runbook for **assess storage drive health** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Confirm the exact condition described by “Assess storage drive health” and identify its first failing dependency.
...
The exact scenario “Assess storage drive health” is resolved and the original business task succeeds.
