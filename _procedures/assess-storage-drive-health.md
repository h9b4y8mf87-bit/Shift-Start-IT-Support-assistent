...
description: Enterprise runbook to assess storage drive health without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for assess storage drive health, verify the original business task, and escalate with complete logs
