...
description: >-
  Enterprise runbook to assess storage drive health without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for assess storage drive health, verify the original business task, and escalate with complete logs if
