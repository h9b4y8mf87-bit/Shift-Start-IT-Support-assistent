...
description: Enterprise runbook to resolve a onedrive sign-in loop without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for resolve a onedrive sign-in loop, verify the original business task, and escalate with complete
...
approval_required: Follow organisational policy for privileged, destructive, security-sensitive or service-impacting
  actions.
permalink: /procedures/resolve-a-onedrive-sign-in-loop/
layout: article
---
## Purpose and scope
