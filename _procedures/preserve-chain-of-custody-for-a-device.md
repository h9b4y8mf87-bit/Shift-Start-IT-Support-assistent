...
description: Enterprise runbook to preserve chain of custody for a device without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for preserve chain of custody for a device, verify the original business task, and escalate with complete
