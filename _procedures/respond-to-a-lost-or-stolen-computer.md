---
title: Respond to a lost or stolen computer
slug: respond-to-a-lost-or-stolen-computer
description: 'Enterprise runbook to respond to a lost or stolen computer without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - to
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for respond to a lost or stolen computer, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - reported-a-lost-or-stolen-computer
  - a-security-or-compliance-concern-is-reported
symptom_weights:
  reported-a-lost-or-stolen-computer: 10
...
permalink: /procedures/respond-to-a-lost-or-stolen-computer/
layout: article
...
The exact scenario “Respond to a lost or stolen computer” is resolved and the original business task succeeds.
