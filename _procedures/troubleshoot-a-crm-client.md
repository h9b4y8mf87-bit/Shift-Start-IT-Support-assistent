...
description: Enterprise runbook to troubleshoot a crm client without skipping evidence, verification, rollback or
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a crm client, verify the original business task, and escalate with complete logs
