...
description: 'Enterprise runbook to issue and track a loan device without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - track
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for issue and track a loan device, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - issue-and-track-a-loan-device
  - hardware-or-peripheral-is-not-functioning
symptom_weights:
  issue-and-track-a-loan-device: 10
...
permalink: /procedures/issue-and-track-a-loan-device/
layout: article
...
---
## Purpose and scope
Use this runbook for **issue and track a loan device** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Confirm the exact condition described by “Issue and track a loan device” and identify its first failing dependency.
...
The exact scenario “Issue and track a loan device” is resolved and the original business task succeeds.
