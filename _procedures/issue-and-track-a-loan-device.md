...
description: Enterprise runbook to issue and track a loan device without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for issue and track a loan device, verify the original business task, and escalate with complete logs
