...
description: >-
  Enterprise runbook to issue and track a loan device without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for issue and track a loan device, verify the original business task, and escalate with complete logs if
