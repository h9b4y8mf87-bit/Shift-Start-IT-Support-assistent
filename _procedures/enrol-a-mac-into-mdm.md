---
title: Enrol a Mac into MDM
slug: enrol-a-mac-into-mdm
description: 'Enterprise runbook to enrol a mac into mdm without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - mdm
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for enrol a mac into mdm, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - enrol-a-mac-into-mdm
  - mac-is-not-working-correctly
  - a-macos-error-or-access-issue-is-reported
symptom_weights:
  enrol-a-mac-into-mdm: 10
...
permalink: /procedures/enrol-a-mac-into-mdm/
layout: article
...
---
## Purpose and scope
Use this runbook for **enrol a mac into mdm** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Confirm the exact condition described by “Enrol a Mac into MDM” and identify its first failing dependency.
...
The exact scenario “Enrol a Mac into MDM” is resolved and the original business task succeeds.
