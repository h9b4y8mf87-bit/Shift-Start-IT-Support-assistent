...
description: Enterprise runbook to assess accidental or liquid damage without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for assess accidental or liquid damage, verify the original business task, and escalate with complete
...
escalation: Escalate to Workplace Hardware or Vendor Support with the exact user or service impact, timestamps and
