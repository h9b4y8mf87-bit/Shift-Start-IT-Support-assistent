---
title: Assess accidental or liquid damage
slug: assess-accidental-or-liquid-damage
description: Enterprise runbook to assess accidental or liquid damage without skipping evidence, verification, rollback or escalation requirements.
...
- or
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for assess accidental or liquid damage, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- need-to-assess-accidental-or-liquid-damage
- hardware-or-peripheral-is-not-functioning
symptom_weights:
  need-to-assess-accidental-or-liquid-damage: 10
...
permalink: /procedures/assess-accidental-or-liquid-damage/
layout: article
...
---
## Purpose and scope
Use this runbook for **assess accidental or liquid damage** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Inspect for swelling, heat, smell, smoke, damaged cable/port, blocked airflow and liquid indicators.
- Stop using and disconnect power when safety risk exists.

### Targeted remediation sequence
1. Move the device to the approved safe process and replace or repair through authorised hardware support.
2. Do not open sealed batteries or continue stress testing unsafe equipment.
