...
description: Enterprise runbook to replace a lost or changed authenticator device without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for replace a lost or changed authenticator device, verify the original business task, and escalate
