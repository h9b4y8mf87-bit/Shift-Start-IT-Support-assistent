---
title: Troubleshoot application printing
slug: troubleshoot-application-printing
description: 'Enterprise runbook to troubleshoot application printing without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot application printing, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - application-printing
  - a-business-application-or-website-is-not-working
symptom_weights:
  application-printing: 10
...
permalink: /procedures/troubleshoot-application-printing/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot application printing** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.

## Mandatory Batch B-5 controls
These audit-derived controls are mandatory before more invasive remediation.

### Pre-checks
1. Test printing from a different application (e.g., Notepad) to isolate application vs. OS/printer.
2. Verify the correct printer is selected and the application's page setup is correct.
3. Check the print server/queue for the specific job.

### Rollback / undo
- If an application update broke printing, roll back the application version or reinstall the print module.
