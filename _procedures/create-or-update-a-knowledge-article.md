---
title: Create or update a knowledge article
slug: create-or-update-a-knowledge-article
description: 'Enterprise runbook to create or update a knowledge article without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - update
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for create or update a knowledge article, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - need-to-create-or-update-a-knowledge-article
  - support-request-requires-triage
  - multiple-users-or-services-may-be-affected
symptom_weights:
  need-to-create-or-update-a-knowledge-article: 10
...
permalink: /procedures/create-or-update-a-knowledge-article/
layout: article
...
---
## Purpose and scope
Use this runbook for **create or update a knowledge article** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Confirm the exact condition described by “Create or update a knowledge article” and identify its first failing dependency.
...
The exact scenario “Create or update a knowledge article” is resolved and the original business task succeeds.
