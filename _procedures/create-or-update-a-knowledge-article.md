...
description: >-
  Enterprise runbook to create or update a knowledge article without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for create or update a knowledge article, verify the original business task, and escalate with complete
