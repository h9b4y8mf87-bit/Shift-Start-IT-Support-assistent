...
description: Enterprise runbook to troubleshoot a laptop display with no image without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a laptop display with no image, verify the original business task, and escalate with
