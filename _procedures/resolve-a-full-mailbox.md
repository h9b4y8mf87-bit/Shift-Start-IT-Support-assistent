...
description: Enterprise runbook to resolve a full mailbox without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for resolve a full mailbox, verify the original business task, and escalate with complete logs if
