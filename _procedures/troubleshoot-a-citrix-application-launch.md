...
description: Enterprise runbook to troubleshoot a citrix application launch without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a citrix application launch, verify the original business task, and escalate with
...
escalation: Escalate to Virtual Workspace or EUC Engineering with the exact user or service impact, timestamps and
