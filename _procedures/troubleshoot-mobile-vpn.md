...
description: >-
  Enterprise runbook to troubleshoot mobile vpn without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot mobile vpn, verify the original business task, and escalate with complete logs if
