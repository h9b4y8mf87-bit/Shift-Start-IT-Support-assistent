---
title: Troubleshoot a damaged or loose charging port
slug: troubleshoot-a-damaged-or-loose-charging-port
description: 'Enterprise runbook to troubleshoot a damaged or loose charging port without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot a damaged or loose charging port, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - a-damaged-or-loose-charging-port
  - hardware-or-peripheral-is-not-functioning
symptom_weights:
  a-damaged-or-loose-charging-port: 10
...
permalink: /procedures/troubleshoot-a-damaged-or-loose-charging-port/
layout: article
