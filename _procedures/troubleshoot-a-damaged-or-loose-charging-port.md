...
description: >-
  Enterprise runbook to troubleshoot a damaged or loose charging port without skipping evidence, verification, rollback
...
tldr: >-
  ...
  remediation for troubleshoot a damaged or loose charging port, verify the original business task, and escalate with
