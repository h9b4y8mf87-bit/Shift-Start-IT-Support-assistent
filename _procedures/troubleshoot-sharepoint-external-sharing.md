...
description: Enterprise runbook to troubleshoot sharepoint external sharing without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot sharepoint external sharing, verify the original business task, and escalate with
