...
description: >-
  Enterprise runbook to troubleshoot dns name resolution without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot dns name resolution, verify the original business task, and escalate with complete logs
