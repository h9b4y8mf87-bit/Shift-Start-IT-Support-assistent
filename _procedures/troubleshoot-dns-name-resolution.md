...
description: Enterprise runbook to troubleshoot dns name resolution without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot dns name resolution, verify the original business task, and escalate with complete
...
---
## Purpose and scope
Use this runbook for **troubleshoot dns name resolution** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
