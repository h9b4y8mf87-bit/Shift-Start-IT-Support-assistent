...
description: >-
  Enterprise runbook to troubleshoot teams camera without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot teams camera, verify the original business task, and escalate with complete logs if
