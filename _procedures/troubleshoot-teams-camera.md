...
description: Enterprise runbook to troubleshoot teams camera without skipping evidence, verification, rollback or
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot teams camera, verify the original business task, and escalate with complete logs
