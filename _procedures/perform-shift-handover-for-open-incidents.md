...
description: Enterprise runbook to perform shift handover for open incidents without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for perform shift handover for open incidents, verify the original business task, and escalate with
