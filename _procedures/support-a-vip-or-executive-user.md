...
description: Enterprise runbook to support a vip or executive user without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for support a vip or executive user, verify the original business task, and escalate with complete
...
approval_required: Follow organisational policy for privileged, destructive, security-sensitive or service-impacting
  actions.
permalink: /procedures/support-a-vip-or-executive-user/
layout: article
---
## Purpose and scope
...
### Targeted checks
- Confirm the exact condition described by “Support a VIP or executive user” and identify its first failing dependency.
...
The exact scenario “Support a VIP or executive user” is resolved and the original business task succeeds.
