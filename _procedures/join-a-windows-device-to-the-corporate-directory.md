...
description: Enterprise runbook to join a windows device to the corporate directory without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for join a windows device to the corporate directory, verify the original business task, and escalate
