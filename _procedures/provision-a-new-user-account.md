...
slug: provision-a-new-user-account
description: Enterprise runbook to provision a new user account without skipping evidence, verification, rollback or escalation requirements.
...
- user
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for provision a new user account, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- need-to-provision-a-new-user-account
- cannot-sign-in
- access-is-denied-or-missing
symptom_weights:
  need-to-provision-a-new-user-account: 10
  cannot-sign-in: 3
...
permalink: /procedures/provision-a-new-user-account/
layout: article
