...
description: Enterprise runbook to provision a new user account without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for provision a new user account, verify the original business task, and escalate with complete logs
