...
description: >-
  Enterprise runbook to provision a new user account without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for provision a new user account, verify the original business task, and escalate with complete logs if
