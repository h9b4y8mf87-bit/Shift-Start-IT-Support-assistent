---
title: Troubleshoot Remote Desktop to a server
slug: troubleshoot-remote-desktop-to-a-server
description: 'Enterprise runbook to troubleshoot remote desktop to a server without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot remote desktop to a server, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - remote-desktop-to-a-server
  - a-server-or-infrastructure-service-is-degraded
symptom_weights:
  remote-desktop-to-a-server: 10
...
permalink: /procedures/troubleshoot-remote-desktop-to-a-server/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot remote desktop to a server** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
