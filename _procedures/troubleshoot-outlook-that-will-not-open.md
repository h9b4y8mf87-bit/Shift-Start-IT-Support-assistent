...
description: Enterprise runbook to troubleshoot outlook that will not open without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot outlook that will not open, verify the original business task, and escalate with
