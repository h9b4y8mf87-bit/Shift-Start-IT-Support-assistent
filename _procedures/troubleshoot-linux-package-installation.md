...
description: >-
  Enterprise runbook to troubleshoot linux package installation without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for troubleshoot linux package installation, verify the original business task, and escalate with complete
