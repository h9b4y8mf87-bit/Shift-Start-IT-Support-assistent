...
description: Enterprise runbook to provision or change a phone extension without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for provision or change a phone extension, verify the original business task, and escalate with complete
...
escalation: Escalate to Unified Communications or AV Support with the exact user or service impact, timestamps and
