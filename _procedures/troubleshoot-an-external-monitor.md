...
description: >-
  Enterprise runbook to troubleshoot an external monitor without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot an external monitor, verify the original business task, and escalate with complete logs
