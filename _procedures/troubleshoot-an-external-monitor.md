...
description: Enterprise runbook to troubleshoot an external monitor without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot an external monitor, verify the original business task, and escalate with complete
