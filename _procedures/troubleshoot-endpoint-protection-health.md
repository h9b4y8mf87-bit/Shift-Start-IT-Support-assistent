...
description: Enterprise runbook to troubleshoot endpoint protection health without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot endpoint protection health, verify the original business task, and escalate with
