---
title: Troubleshoot endpoint protection health
slug: troubleshoot-endpoint-protection-health
description: Enterprise runbook to troubleshoot endpoint protection health without skipping evidence, verification, rollback or escalation requirements.
...
- troubleshoot
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot endpoint protection health, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- endpoint-protection-health
- a-security-or-compliance-concern-is-reported
symptom_weights:
  endpoint-protection-health: 10
...
permalink: /procedures/troubleshoot-endpoint-protection-health/
layout: article
...
### Targeted checks
- Confirm the exact condition described by “Troubleshoot endpoint protection health” and identify its first failing dependency.
