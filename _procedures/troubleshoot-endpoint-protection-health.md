...
description: >-
  Enterprise runbook to troubleshoot endpoint protection health without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for troubleshoot endpoint protection health, verify the original business task, and escalate with complete
