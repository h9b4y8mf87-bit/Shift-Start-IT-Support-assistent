...
description: >-
  Enterprise runbook to restore a sharepoint file version without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for restore a sharepoint file version, verify the original business task, and escalate with complete logs
