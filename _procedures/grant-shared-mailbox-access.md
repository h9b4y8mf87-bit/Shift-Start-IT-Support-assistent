...
description: Enterprise runbook to grant shared mailbox access without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for grant shared mailbox access, verify the original business task, and escalate with complete logs
