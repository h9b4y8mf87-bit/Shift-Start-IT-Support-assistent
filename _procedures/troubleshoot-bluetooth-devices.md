---
title: Troubleshoot Bluetooth devices
slug: troubleshoot-bluetooth-devices
description: 'Enterprise runbook to troubleshoot bluetooth devices without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - windows-endpoints
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot bluetooth devices, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - bluetooth-devices
...
permalink: /procedures/troubleshoot-bluetooth-devices/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot bluetooth devices** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.

## Mandatory Batch B-5 controls
These audit-derived controls are mandatory before more invasive remediation.

### Pre-checks
1. Verify Bluetooth is turned on in Windows/macOS settings.
2. Check Device Manager for Bluetooth driver errors.
3. Put the Bluetooth device in pairing mode and try re-pairing.

### Rollback / undo
- If a driver update broke Bluetooth, roll back the driver via Device Manager.
