...
description: Enterprise runbook to troubleshoot bluetooth devices without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot bluetooth devices, verify the original business task, and escalate with complete
