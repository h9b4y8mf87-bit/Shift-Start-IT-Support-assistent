---
title: Troubleshoot poor call quality
slug: troubleshoot-poor-call-quality
description: 'Enterprise runbook to troubleshoot poor call quality without skipping evidence, verification, rollback or escalation requirements.'
...
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot poor call quality, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - poor-call-quality
  - calling-audio-video-or-meeting-room-technology-is-not-working
symptom_weights:
  poor-call-quality: 10
...
permalink: /procedures/troubleshoot-poor-call-quality/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot poor call quality** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
