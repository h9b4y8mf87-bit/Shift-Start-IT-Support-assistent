...
description: >-
  Enterprise runbook to troubleshoot poor call quality without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot poor call quality, verify the original business task, and escalate with complete logs if
