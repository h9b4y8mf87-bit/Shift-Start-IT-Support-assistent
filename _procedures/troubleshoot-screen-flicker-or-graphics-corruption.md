---
title: Troubleshoot screen flicker or graphics corruption
slug: troubleshoot-screen-flicker-or-graphics-corruption
description: 'Enterprise runbook to troubleshoot screen flicker or graphics corruption without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - windows-endpoints
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot screen flicker or graphics corruption, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - screen-flicker-or-graphics-corruption
  - windows-device-is-not-working-correctly
  - a-windows-error-or-performance-issue-is-reported
symptom_weights:
  screen-flicker-or-graphics-corruption: 10
...
permalink: /procedures/troubleshoot-screen-flicker-or-graphics-corruption/
layout: article
...
### Targeted checks
- Confirm the exact condition described by “Troubleshoot screen flicker or graphics corruption” and identify its first failing dependency.
...
The exact scenario “Troubleshoot screen flicker or graphics corruption” is resolved and the original business task succeeds.
