...
description: Enterprise runbook to troubleshoot screen flicker or graphics corruption without skipping evidence,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot screen flicker or graphics corruption, verify the original business task, and escalate
