---
title: Triage a home-network remote-work issue
slug: triage-a-home-network-remote-work-issue
description: Enterprise runbook to triage a home-network remote-work issue without skipping evidence, verification, rollback or escalation requirements.
...
- work
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for triage a home-network remote-work issue, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- a-home-network-remote-work-issue
- remote-desktop-or-virtual-application-access-is-failing
symptom_weights:
  a-home-network-remote-work-issue: 10
...
permalink: /procedures/triage-a-home-network-remote-work-issue/
layout: article
...
---
## Purpose and scope
Use this runbook for **triage a home-network remote-work issue** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Confirm the exact condition described by “Triage a home-network remote-work issue” and identify its first failing dependency.
...
The exact scenario “Triage a home-network remote-work issue” is resolved and the original business task succeeds.
