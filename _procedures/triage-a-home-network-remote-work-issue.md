...
description: Enterprise runbook to triage a home-network remote-work issue without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for triage a home-network remote-work issue, verify the original business task, and escalate with
