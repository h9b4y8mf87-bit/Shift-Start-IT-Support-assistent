...
description: Enterprise runbook to handle a duplicate incident without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for handle a duplicate incident, verify the original business task, and escalate with complete logs
