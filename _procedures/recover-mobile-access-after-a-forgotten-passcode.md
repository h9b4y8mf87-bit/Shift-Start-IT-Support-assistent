---
title: Recover mobile access after a forgotten passcode
slug: recover-mobile-access-after-a-forgotten-passcode
description: 'Enterprise runbook to recover mobile access after a forgotten passcode without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - recover
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for recover mobile access after a forgotten passcode, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - mobile-access-after-a-forgotten-passcode
  - corporate-access-on-a-mobile-device-is-not-working
  - mobile-device-is-not-compliant
symptom_weights:
  mobile-access-after-a-forgotten-passcode: 10
...
permalink: /procedures/recover-mobile-access-after-a-forgotten-passcode/
layout: article
...
### Targeted checks
- Confirm the exact condition described by “Recover mobile access after a forgotten passcode” and identify its first failing dependency.
...
The exact scenario “Recover mobile access after a forgotten passcode” is resolved and the original business task succeeds.
