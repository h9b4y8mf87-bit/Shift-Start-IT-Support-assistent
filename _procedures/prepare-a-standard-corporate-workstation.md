---
title: Prepare a standard corporate workstation
slug: prepare-a-standard-corporate-workstation
description: 'Enterprise runbook to prepare a standard corporate workstation without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - workstation
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for prepare a standard corporate workstation, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - need-to-prepare-a-standard-corporate-workstation
  - a-device-software-or-asset-lifecycle-request-is-required
symptom_weights:
  need-to-prepare-a-standard-corporate-workstation: 10
...
permalink: /procedures/prepare-a-standard-corporate-workstation/
layout: article
...
---
## Purpose and scope
Use this runbook for **prepare a standard corporate workstation** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Validate request, identity, location, role, asset, accessories, standard build and approvals.
- Record chain of custody and existing assignment before movement or replacement.

### Targeted remediation sequence
1. Execute the lifecycle checklist and update inventory/licence records at each handoff.
2. Route missing, damaged or non-standard items to the accountable owner.
