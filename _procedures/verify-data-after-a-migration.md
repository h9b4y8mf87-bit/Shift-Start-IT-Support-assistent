...
description: Enterprise runbook to verify data after a migration without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for verify data after a migration, verify the original business task, and escalate with complete logs
