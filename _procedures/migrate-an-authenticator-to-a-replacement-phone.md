...
description: >-
  Enterprise runbook to migrate an authenticator to a replacement phone without skipping evidence, verification,
...
tldr: >-
  ...
  remediation for migrate an authenticator to a replacement phone, verify the original business task, and escalate with
