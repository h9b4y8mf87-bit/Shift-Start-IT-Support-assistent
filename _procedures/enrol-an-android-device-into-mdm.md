...
description: >-
  Enterprise runbook to enrol an android device into mdm without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for enrol an android device into mdm, verify the original business task, and escalate with complete logs
