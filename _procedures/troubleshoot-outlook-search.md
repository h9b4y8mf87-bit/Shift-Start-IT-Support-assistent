...
description: Enterprise runbook to troubleshoot outlook search without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot outlook search, verify the original business task, and escalate with complete logs
