...
description: Enterprise runbook to triage a vlan assignment issue without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for triage a vlan assignment issue, verify the original business task, and escalate with complete
