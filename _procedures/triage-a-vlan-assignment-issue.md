...
description: >-
  Enterprise runbook to triage a vlan assignment issue without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for triage a vlan assignment issue, verify the original business task, and escalate with complete logs if
