...
description: >-
  Enterprise runbook to troubleshoot a stopped windows server service without skipping evidence, verification, rollback
...
tldr: >-
  ...
  remediation for troubleshoot a stopped windows server service, verify the original business task, and escalate with
