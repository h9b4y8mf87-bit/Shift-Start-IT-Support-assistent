...
description: Enterprise runbook to classify incident category and priority without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for classify incident category and priority, verify the original business task, and escalate with
