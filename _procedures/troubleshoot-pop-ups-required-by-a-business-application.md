---
title: Troubleshoot pop-ups required by a business application
slug: troubleshoot-pop-ups-required-by-a-business-application
description: 'Enterprise runbook to troubleshoot pop-ups required by a business application without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - ups
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot pop-ups required by a business application, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - pop-ups-required-by-a-business-application
  - a-business-application-or-website-is-not-working
symptom_weights:
  pop-ups-required-by-a-business-application: 10
...
permalink: /procedures/troubleshoot-pop-ups-required-by-a-business-application/
layout: article
