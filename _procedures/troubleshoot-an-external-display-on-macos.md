...
description: >-
  Enterprise runbook to troubleshoot an external display on macos without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for troubleshoot an external display on macos, verify the original business task, and escalate with
