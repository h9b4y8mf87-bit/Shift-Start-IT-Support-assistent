...
description: Enterprise runbook to troubleshoot single sign-on failure without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot single sign-on failure, verify the original business task, and escalate with complete
