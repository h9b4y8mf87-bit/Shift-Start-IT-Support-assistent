---
title: Troubleshoot a VMware virtual machine that is unresponsive
slug: troubleshoot-a-vmware-virtual-machine-that-is-unresponsive
description: 'Enterprise runbook to troubleshoot a vmware virtual machine that is unresponsive without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - vmware
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot a vmware virtual machine that is unresponsive, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - a-vmware-virtual-machine-that-is-unresponsive
  - a-cloud-or-virtual-resource-is-degraded
symptom_weights:
  a-vmware-virtual-machine-that-is-unresponsive: 10
...
permalink: /procedures/troubleshoot-a-vmware-virtual-machine-that-is-unresponsive/
layout: article
