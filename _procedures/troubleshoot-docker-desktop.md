...
description: >-
  Enterprise runbook to troubleshoot docker desktop without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot docker desktop, verify the original business task, and escalate with complete logs if
