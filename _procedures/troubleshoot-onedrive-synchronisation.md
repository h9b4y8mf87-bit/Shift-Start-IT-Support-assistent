---
title: Troubleshoot OneDrive synchronisation
slug: troubleshoot-onedrive-synchronisation
description: 'Enterprise runbook to troubleshoot onedrive synchronisation without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot onedrive synchronisation, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - onedrive-synchronisation
  - microsoft-365-feature-is-not-working
  - cloud-collaboration-access-is-failing
symptom_weights:
  onedrive-synchronisation: 10
...
permalink: /procedures/troubleshoot-onedrive-synchronisation/
layout: article
