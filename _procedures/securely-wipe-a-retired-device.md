...
description: >-
  Enterprise runbook to securely wipe a retired device without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for securely wipe a retired device, verify the original business task, and escalate with complete logs if
