...
description: Enterprise runbook to securely wipe a retired device without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for securely wipe a retired device, verify the original business task, and escalate with complete
