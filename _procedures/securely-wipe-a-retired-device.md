---
title: Securely wipe a retired device
slug: securely-wipe-a-retired-device
description: 'Enterprise runbook to securely wipe a retired device without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - wipe
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for securely wipe a retired device, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - need-to-securely-wipe-a-retired-device
  - a-device-software-or-asset-lifecycle-request-is-required
symptom_weights:
  need-to-securely-wipe-a-retired-device: 10
...
permalink: /procedures/securely-wipe-a-retired-device/
layout: article
...
---
## Purpose and scope
Use this runbook for **securely wipe a retired device** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Confirm the exact condition described by “Securely wipe a retired device” and identify its first failing dependency.
...
The exact scenario “Securely wipe a retired device” is resolved and the original business task succeeds.
