...
description: Enterprise runbook to troubleshoot hdmi presentation input without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot hdmi presentation input, verify the original business task, and escalate with complete
