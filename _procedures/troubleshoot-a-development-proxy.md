---
title: Troubleshoot a development proxy
slug: troubleshoot-a-development-proxy
description: Enterprise runbook to troubleshoot a development proxy without skipping evidence, verification, rollback or escalation requirements.
...
- troubleshoot
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot a development proxy, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- a-development-proxy
- linux-or-developer-tooling-is-not-working
symptom_weights:
  a-development-proxy: 10
...
permalink: /procedures/troubleshoot-a-development-proxy/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot a development proxy** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
