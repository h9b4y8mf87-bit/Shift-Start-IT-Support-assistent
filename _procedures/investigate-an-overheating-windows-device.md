...
description: Enterprise runbook to investigate an overheating windows device without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for investigate an overheating windows device, verify the original business task, and escalate with
