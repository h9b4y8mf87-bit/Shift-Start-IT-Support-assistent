...
description: 'Enterprise runbook to investigate an overheating windows device without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - windows-endpoints
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for investigate an overheating windows device, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
...
symptom_weights:
  investigate-an-overheating-windows-device: 10
...
permalink: /procedures/investigate-an-overheating-windows-device/
layout: article
...
---
## Purpose and scope
Use this runbook for **investigate an overheating windows device** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
