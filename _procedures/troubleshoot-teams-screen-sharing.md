---
title: Troubleshoot Teams screen sharing
slug: troubleshoot-teams-screen-sharing
description: 'Enterprise runbook to troubleshoot teams screen sharing without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot teams screen sharing, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - teams-screen-sharing
  - microsoft-365-feature-is-not-working
  - cloud-collaboration-access-is-failing
symptom_weights:
  teams-screen-sharing: 10
...
permalink: /procedures/troubleshoot-teams-screen-sharing/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot teams screen sharing** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.

## Mandatory Batch B-2 controls
These audit-derived controls are mandatory before more invasive remediation.

### Pre-checks
1. Check meeting role/presenter permission before client remediation.
2. Check OS screen-recording/privacy permission and monitor/application selection.
3. Check uplink/media quality and whether application-window sharing works as a controlled comparison.

### Rollback / undo
- Record client/permission configuration before change. Restore the previous approved Teams/client configuration if an authorised update or policy change causes regression.
