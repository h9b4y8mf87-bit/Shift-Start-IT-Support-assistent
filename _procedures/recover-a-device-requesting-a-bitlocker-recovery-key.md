...
description: Enterprise runbook to recover a device requesting a bitlocker recovery key without skipping evidence,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for recover a device requesting a bitlocker recovery key, verify the original business task, and escalate
