...
description: >-
  Enterprise runbook to troubleshoot high load on linux without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot high load on linux, verify the original business task, and escalate with complete logs if
