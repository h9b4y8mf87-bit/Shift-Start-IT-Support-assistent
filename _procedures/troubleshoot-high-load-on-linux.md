---
title: Troubleshoot high load on Linux
slug: troubleshoot-high-load-on-linux
description: 'Enterprise runbook to troubleshoot high load on linux without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot high load on linux, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - high-load-on-linux
  - linux-or-developer-tooling-is-not-working
symptom_weights:
  high-load-on-linux: 10
...
permalink: /procedures/troubleshoot-high-load-on-linux/
layout: article
