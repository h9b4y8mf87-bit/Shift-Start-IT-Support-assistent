...
description: Enterprise runbook to troubleshoot an azure virtual machine that is unreachable without skipping evidence,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot an azure virtual machine that is unreachable, verify the original business task,
...
approval_required: Follow organisational policy for privileged, destructive, security-sensitive or service-impacting
  actions.
permalink: /procedures/troubleshoot-an-azure-virtual-machine-that-is-unreachable/
layout: article
---
## Purpose and scope
