...
description: Enterprise runbook to troubleshoot citrix audio or microphone without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot citrix audio or microphone, verify the original business task, and escalate with
