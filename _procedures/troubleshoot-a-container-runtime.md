...
description: Enterprise runbook to troubleshoot a container runtime without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a container runtime, verify the original business task, and escalate with complete
