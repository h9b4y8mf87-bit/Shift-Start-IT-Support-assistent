...
description: Enterprise runbook to respond to a suspected phishing message without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for respond to a suspected phishing message, verify the original business task, and escalate with
