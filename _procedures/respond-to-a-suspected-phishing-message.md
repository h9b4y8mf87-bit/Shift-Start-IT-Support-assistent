...
description: >-
  Enterprise runbook to respond to a suspected phishing message without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for respond to a suspected phishing message, verify the original business task, and escalate with complete
