...
description: Enterprise runbook to link an incident to a recent change without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for link an incident to a recent change, verify the original business task, and escalate with complete
