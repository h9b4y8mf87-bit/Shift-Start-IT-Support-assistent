---
title: Troubleshoot directory synchronisation
slug: troubleshoot-directory-synchronisation
description: 'Enterprise runbook to troubleshoot directory synchronisation without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot directory synchronisation, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - directory-synchronisation
  - cannot-sign-in
  - access-is-denied-or-missing
symptom_weights:
  directory-synchronisation: 10
  cannot-sign-in: 3
...
permalink: /procedures/troubleshoot-directory-synchronisation/
layout: article
