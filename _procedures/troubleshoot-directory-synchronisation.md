...
description: >-
  Enterprise runbook to troubleshoot directory synchronisation without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for troubleshoot directory synchronisation, verify the original business task, and escalate with complete
