---
title: Troubleshoot Known Folder Move
slug: troubleshoot-known-folder-move
description: 'Enterprise runbook to troubleshoot known folder move without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot known folder move, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - known-folder-move
  - microsoft-365-feature-is-not-working
  - cloud-collaboration-access-is-failing
symptom_weights:
  known-folder-move: 10
...
permalink: /procedures/troubleshoot-known-folder-move/
layout: article
