---
title: Troubleshoot a Java-based business application
slug: troubleshoot-a-java-based-business-application
description: 'Enterprise runbook to troubleshoot a java-based business application without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot a java-based business application, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - a-java-based-business-application
  - a-business-application-or-website-is-not-working
symptom_weights:
  a-java-based-business-application: 10
...
permalink: /procedures/troubleshoot-a-java-based-business-application/
layout: article
