...
description: Enterprise runbook to troubleshoot a java-based business application without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a java-based business application, verify the original business task, and escalate
