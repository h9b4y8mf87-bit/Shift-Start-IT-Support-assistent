...
description: >-
  Enterprise runbook to troubleshoot a java-based business application without skipping evidence, verification, rollback
...
tldr: >-
  ...
  remediation for troubleshoot a java-based business application, verify the original business task, and escalate with
