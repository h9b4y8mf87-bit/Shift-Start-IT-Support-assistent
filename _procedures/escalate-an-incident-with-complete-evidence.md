...
description: Enterprise runbook to escalate an incident with complete evidence without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for escalate an incident with complete evidence, verify the original business task, and escalate with
