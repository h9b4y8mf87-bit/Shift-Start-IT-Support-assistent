...
description: Enterprise runbook to resolve blocked office macros safely without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for resolve blocked office macros safely, verify the original business task, and escalate with complete
