...
description: >-
  Enterprise runbook to troubleshoot an odbc data source without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot an odbc data source, verify the original business task, and escalate with complete logs
