---
title: Troubleshoot an ODBC data source
slug: troubleshoot-an-odbc-data-source
description: 'Enterprise runbook to troubleshoot an odbc data source without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot an odbc data source, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - an-odbc-data-source
  - a-server-or-infrastructure-service-is-degraded
symptom_weights:
  an-odbc-data-source: 10
...
permalink: /procedures/troubleshoot-an-odbc-data-source/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot an odbc data source** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Confirm the exact condition described by “Troubleshoot an ODBC data source” and identify its first failing dependency.
...
The exact scenario “Troubleshoot an ODBC data source” is resolved and the original business task succeeds.
