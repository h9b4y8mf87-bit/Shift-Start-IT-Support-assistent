...
description: Enterprise runbook to troubleshoot an odbc data source without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot an odbc data source, verify the original business task, and escalate with complete
