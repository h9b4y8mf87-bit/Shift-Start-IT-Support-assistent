...
description: >-
  Enterprise runbook to resolve an application role assignment failure without skipping evidence, verification, rollback
...
tldr: >-
  ...
  remediation for resolve an application role assignment failure, verify the original business task, and escalate with
