...
description: >-
  Enterprise runbook to apply an approved standard configuration without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for apply an approved standard configuration, verify the original business task, and escalate with
