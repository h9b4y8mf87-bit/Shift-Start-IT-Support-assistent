...
description: Enterprise runbook to resolve an antivirus false positive without skipping evidence, verification,
...
approval_required: Follow organisational policy for privileged, destructive, security-sensitive or service-impacting
  actions.
permalink: /procedures/resolve-an-antivirus-false-positive/
layout: article
---
## Purpose and scope
...
### Targeted checks
- Confirm the exact condition described by “Resolve an antivirus false positive” and identify its first failing dependency.
...
The exact scenario “Resolve an antivirus false positive” is resolved and the original business task succeeds.
