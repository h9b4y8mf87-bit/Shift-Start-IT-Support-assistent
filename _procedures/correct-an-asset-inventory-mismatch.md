...
description: >-
  Enterprise runbook to correct an asset inventory mismatch without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for correct an asset inventory mismatch, verify the original business task, and escalate with complete
