...
description: Enterprise runbook to validate microsoft 365 service health without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for validate microsoft 365 service health, verify the original business task, and escalate with complete
