...
description: Enterprise runbook to complete a post-incident review without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for complete a post-incident review, verify the original business task, and escalate with complete
