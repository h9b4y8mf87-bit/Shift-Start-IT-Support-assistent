...
description: >-
  Enterprise runbook to complete a post-incident review without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for complete a post-incident review, verify the original business task, and escalate with complete logs if
