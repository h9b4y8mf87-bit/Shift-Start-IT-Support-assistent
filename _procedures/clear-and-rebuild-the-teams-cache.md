...
description: >-
  Enterprise runbook to clear and rebuild the teams cache without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for clear and rebuild the teams cache, verify the original business task, and escalate with complete logs
