...
description: Enterprise runbook to clear and rebuild the teams cache without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for clear and rebuild the teams cache, verify the original business task, and escalate with complete
