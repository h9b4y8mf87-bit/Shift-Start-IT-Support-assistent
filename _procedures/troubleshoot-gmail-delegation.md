---
title: Troubleshoot Gmail delegation
slug: troubleshoot-gmail-delegation
description: 'Enterprise runbook to troubleshoot gmail delegation without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot gmail delegation, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - gmail-delegation
...
permalink: /procedures/troubleshoot-gmail-delegation/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot gmail delegation** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.

## Mandatory Batch B-5 controls
These audit-derived controls are mandatory before more invasive remediation.

### Pre-checks
1. Check Google Workspace Admin console for delegated user permissions.
2. Verify the delegate has been granted the correct access level (Send As, Read, Manage).
3. Test access from the Gmail web interface.

### Rollback / undo
- If a delegation change broke access, revert the permission immediately via the Google Admin console.
