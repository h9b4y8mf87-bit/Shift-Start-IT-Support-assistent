...
description: Enterprise runbook to troubleshoot passwordless sign-in without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot passwordless sign-in, verify the original business task, and escalate with complete
