...
description: Enterprise runbook to repair an outlook profile without skipping evidence, verification, rollback or
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for repair an outlook profile, verify the original business task, and escalate with complete logs
