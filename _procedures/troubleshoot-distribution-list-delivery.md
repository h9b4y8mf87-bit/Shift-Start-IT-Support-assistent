...
description: Enterprise runbook to troubleshoot distribution-list delivery without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot distribution-list delivery, verify the original business task, and escalate with
