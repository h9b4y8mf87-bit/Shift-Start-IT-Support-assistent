...
description: Enterprise runbook to resolve a duplicate ip address without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for resolve a duplicate ip address, verify the original business task, and escalate with complete
