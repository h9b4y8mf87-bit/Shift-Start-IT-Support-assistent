---
title: Clear browser cache and cookies safely
slug: clear-browser-cache-and-cookies-safely
description: Enterprise runbook to clear browser cache and cookies safely without skipping evidence, verification, rollback or escalation requirements.
...
- safely
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for clear browser cache and cookies safely, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- browser-cache-and-cookies-safely
- a-business-application-or-website-is-not-working
symptom_weights:
  browser-cache-and-cookies-safely: 10
...
permalink: /procedures/clear-browser-cache-and-cookies-safely/
layout: article
...
---
## Purpose and scope
Use this runbook for **clear browser cache and cookies safely** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
...
### Targeted checks
- Confirm the exact condition described by “Clear browser cache and cookies safely” and identify its first failing dependency.
...
The exact scenario “Clear browser cache and cookies safely” is resolved and the original business task succeeds.
