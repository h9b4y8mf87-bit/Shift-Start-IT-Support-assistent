...
description: >-
  Enterprise runbook to clear browser cache and cookies safely without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for clear browser cache and cookies safely, verify the original business task, and escalate with complete
