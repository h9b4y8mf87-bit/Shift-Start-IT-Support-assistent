...
description: Enterprise runbook to troubleshoot vdi performance without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot vdi performance, verify the original business task, and escalate with complete logs
