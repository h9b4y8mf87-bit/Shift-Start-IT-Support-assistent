...
description: >-
  Enterprise runbook to troubleshoot vdi performance without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot vdi performance, verify the original business task, and escalate with complete logs if
