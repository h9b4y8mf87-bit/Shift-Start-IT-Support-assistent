...
description: >-
  Enterprise runbook to record a new asset in inventory without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for record a new asset in inventory, verify the original business task, and escalate with complete logs if
