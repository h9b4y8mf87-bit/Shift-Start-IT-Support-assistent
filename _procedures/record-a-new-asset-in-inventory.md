---
title: Record a new asset in inventory
slug: record-a-new-asset-in-inventory
description: 'Enterprise runbook to record a new asset in inventory without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - record
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for record a new asset in inventory, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - need-to-record-a-new-asset-in-inventory
  - a-device-software-or-asset-lifecycle-request-is-required
symptom_weights:
  need-to-record-a-new-asset-in-inventory: 10
...
permalink: /procedures/record-a-new-asset-in-inventory/
layout: article
...
---
## Purpose and scope
Use this runbook for **record a new asset in inventory** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
