...
description: Enterprise runbook to record a new asset in inventory without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for record a new asset in inventory, verify the original business task, and escalate with complete
