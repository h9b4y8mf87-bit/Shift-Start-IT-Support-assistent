...
description: >-
  Enterprise runbook to audit assigned equipment without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for audit assigned equipment, verify the original business task, and escalate with complete logs if
