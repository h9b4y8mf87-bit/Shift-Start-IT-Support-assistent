...
### Pre-checks
1. Check the authoritative asset record for expected accessories and ownership/custody.
2. Verify the physical accessories and identifiers where applicable, recording discrepancies without fabricating missing evidence.
3. Route missing/damaged accessories to the organisation's asset/loss process rather than treating inventory validation as an incident.

### Rollback / undo
- Inventory validation itself has no technical rollback. Correct an erroneous asset-record update through the approved asset-management audit trail rather than deleting history.
