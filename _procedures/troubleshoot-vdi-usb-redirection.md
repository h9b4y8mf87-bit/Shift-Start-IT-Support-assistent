...
description: >-
  Enterprise runbook to troubleshoot vdi usb redirection without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot vdi usb redirection, verify the original business task, and escalate with complete logs
