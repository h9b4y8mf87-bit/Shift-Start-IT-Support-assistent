---
title: Troubleshoot VDI USB redirection
slug: troubleshoot-vdi-usb-redirection
description: 'Enterprise runbook to troubleshoot vdi usb redirection without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - vdi
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot vdi usb redirection, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - vdi-usb-redirection
  - remote-desktop-or-virtual-application-access-is-failing
symptom_weights:
  vdi-usb-redirection: 10
...
permalink: /procedures/troubleshoot-vdi-usb-redirection/
layout: article
