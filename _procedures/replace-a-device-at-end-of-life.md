...
description: 'Enterprise runbook to replace a device at end of life without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - replace
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for replace a device at end of life, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - replace-a-device-at-end-of-life
  - a-device-software-or-asset-lifecycle-request-is-required
symptom_weights:
  replace-a-device-at-end-of-life: 10
...
permalink: /procedures/replace-a-device-at-end-of-life/
layout: article
...
---
## Purpose and scope
Use this runbook for **replace a device at end of life** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.
