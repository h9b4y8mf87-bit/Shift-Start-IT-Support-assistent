...
description: >-
  Enterprise runbook to replace a device at end of life without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for replace a device at end of life, verify the original business task, and escalate with complete logs if
