...
description: Enterprise runbook to troubleshoot a windows certificate service request without skipping evidence,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot a windows certificate service request, verify the original business task, and escalate
