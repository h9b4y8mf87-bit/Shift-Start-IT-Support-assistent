...
description: >-
  Enterprise runbook to troubleshoot an rds session without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot an rds session, verify the original business task, and escalate with complete logs if
