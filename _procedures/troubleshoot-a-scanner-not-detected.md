---
title: Troubleshoot a scanner not detected
slug: troubleshoot-a-scanner-not-detected
description: 'Enterprise runbook to troubleshoot a scanner not detected without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot a scanner not detected, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - a-scanner-not-detected
  - printing-or-scanning-is-not-working
symptom_weights:
  a-scanner-not-detected: 10
...
permalink: /procedures/troubleshoot-a-scanner-not-detected/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot a scanner not detected** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.

## Mandatory Batch B-4 controls
These audit-derived controls are mandatory before more invasive remediation.

### Pre-checks
1. Check the scanner's network connectivity (ping the IP) or USB connection.
2. Verify the scanner driver is installed and the TWAIN/WIA service is running.
3. Test the scanner from another computer to isolate the device vs. the workstation.

### Rollback / undo
- If a driver update broke scanning, roll back the driver via Device Manager.
