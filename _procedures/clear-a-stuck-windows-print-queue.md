...
description: >-
  Enterprise runbook to clear a stuck windows print queue without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for clear a stuck windows print queue, verify the original business task, and escalate with complete logs
