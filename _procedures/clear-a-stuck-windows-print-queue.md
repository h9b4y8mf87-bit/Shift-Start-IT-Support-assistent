...
description: Enterprise runbook to clear a stuck windows print queue without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for clear a stuck windows print queue, verify the original business task, and escalate with complete
