---
title: Troubleshoot no Wi-Fi connectivity
slug: troubleshoot-no-wi-fi-connectivity
description: 'Enterprise runbook to troubleshoot no wi-fi connectivity without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - wi
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot no wi-fi connectivity, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - no-wi-fi-connectivity
  - network-or-internet-access-is-unavailable
  - connection-is-slow-or-intermittent
symptom_weights:
  no-wi-fi-connectivity: 10
...
permalink: /procedures/troubleshoot-no-wi-fi-connectivity/
layout: article
