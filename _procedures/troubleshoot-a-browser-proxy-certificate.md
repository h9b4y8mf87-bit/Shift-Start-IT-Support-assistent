...
description: >-
  Enterprise runbook to troubleshoot a browser proxy certificate without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for troubleshoot a browser proxy certificate, verify the original business task, and escalate with
...
escalation: >-
  Escalate to Application Support with the exact user or service impact, timestamps and timezone, affected assets,
