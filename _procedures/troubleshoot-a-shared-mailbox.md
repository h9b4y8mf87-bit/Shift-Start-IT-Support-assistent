---
title: Troubleshoot a shared mailbox
slug: troubleshoot-a-shared-mailbox
description: Enterprise runbook to troubleshoot a shared mailbox without skipping evidence, verification, rollback or escalation requirements.
...
- troubleshoot
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot a shared mailbox, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- a-shared-mailbox
...
permalink: /procedures/troubleshoot-a-shared-mailbox/
layout: article
