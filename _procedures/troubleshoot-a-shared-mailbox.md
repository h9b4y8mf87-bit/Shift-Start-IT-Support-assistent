...
description: >-
  Enterprise runbook to troubleshoot a shared mailbox without skipping evidence, verification, rollback or escalation
  requirements.
...
tldr: >-
  ...
  remediation for troubleshoot a shared mailbox, verify the original business task, and escalate with complete logs if
