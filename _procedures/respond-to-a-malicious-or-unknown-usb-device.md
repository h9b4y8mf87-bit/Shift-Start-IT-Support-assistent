---
title: Respond to a malicious or unknown USB device
slug: respond-to-a-malicious-or-unknown-usb-device
description: Enterprise runbook to respond to a malicious or unknown usb device without skipping evidence, verification, rollback or escalation requirements.
...
- usb
error_codes: []
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for respond to a malicious or unknown usb device, verify the original business task, and escalate with complete logs if recovery is not achieved.
related_symptoms:
- reported-a-malicious-or-unknown-usb-device
- a-security-or-compliance-concern-is-reported
symptom_weights:
  reported-a-malicious-or-unknown-usb-device: 10
...
permalink: /procedures/respond-to-a-malicious-or-unknown-usb-device/
layout: article
