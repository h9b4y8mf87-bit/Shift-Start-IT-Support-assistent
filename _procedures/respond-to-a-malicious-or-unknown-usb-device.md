...
description: Enterprise runbook to respond to a malicious or unknown usb device without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for respond to a malicious or unknown usb device, verify the original business task, and escalate
