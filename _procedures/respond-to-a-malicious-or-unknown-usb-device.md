...
description: >-
  Enterprise runbook to respond to a malicious or unknown usb device without skipping evidence, verification, rollback
...
tldr: >-
  ...
  remediation for respond to a malicious or unknown usb device, verify the original business task, and escalate with
