---
title: Troubleshoot Outlook add-ins
slug: troubleshoot-outlook-add-ins
description: 'Enterprise runbook to troubleshoot outlook add-ins without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot outlook add-ins, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - outlook-add-ins
...
permalink: /procedures/troubleshoot-outlook-add-ins/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot outlook add-ins** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.

## Mandatory Batch B-2 controls
These audit-derived controls are mandatory before more invasive remediation.

### Pre-checks
1. Start Outlook in Safe Mode to determine whether add-ins are involved.
2. Record enabled COM/web add-ins and their load state before disabling anything.
3. Check whether the add-in depends on a network service, authentication or vendor backend.

### Rollback / undo
- Document each add-in disabled during testing and re-enable only the known-good add-ins after isolating the fault.
