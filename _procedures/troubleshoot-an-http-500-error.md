---
title: Troubleshoot an HTTP 500 error
slug: troubleshoot-an-http-500-error
description: 'Enterprise runbook to troubleshoot an http 500 error without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot an http 500 error, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - an-http-500-error
  - a-business-application-or-website-is-not-working
symptom_weights:
  an-http-500-error: 10
...
permalink: /procedures/troubleshoot-an-http-500-error/
layout: article
