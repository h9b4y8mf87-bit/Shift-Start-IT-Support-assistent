...
description: 'Enterprise runbook to triage an office or site-wide outage without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - wide
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for triage an office or site-wide outage, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
...
The exact scenario “Triage an office or site-wide outage” is resolved and the original business task succeeds.
