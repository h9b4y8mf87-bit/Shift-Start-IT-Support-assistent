...
description: Enterprise runbook to triage an office or site-wide outage without skipping evidence, verification,
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for triage an office or site-wide outage, verify the original business task, and escalate with complete
