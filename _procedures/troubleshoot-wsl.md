---
title: Troubleshoot WSL
slug: troubleshoot-wsl
description: 'Enterprise runbook to troubleshoot wsl without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - wsl
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot wsl, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - wsl
...
permalink: /procedures/troubleshoot-wsl/
layout: article
