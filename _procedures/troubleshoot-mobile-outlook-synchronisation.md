---
title: Troubleshoot mobile Outlook synchronisation
slug: troubleshoot-mobile-outlook-synchronisation
description: 'Enterprise runbook to troubleshoot mobile outlook synchronisation without skipping evidence, verification, rollback or escalation requirements.'
...
tags:
  ...
  - troubleshoot
error_codes: []
tldr: 'Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved remediation for troubleshoot mobile outlook synchronisation, verify the original business task, and escalate with complete logs if recovery is not achieved.'
related_symptoms:
  - mobile-outlook-synchronisation
  - corporate-access-on-a-mobile-device-is-not-working
  - mobile-device-is-not-compliant
symptom_weights:
  mobile-outlook-synchronisation: 10
...
permalink: /procedures/troubleshoot-mobile-outlook-synchronisation/
layout: article
...
---
## Purpose and scope
Use this runbook for **troubleshoot mobile outlook synchronisation** in a managed enterprise environment. It covers intake, evidence, safe diagnosis, remediation, verification, documentation and escalation. It does not replace organisation-specific security, change, safety, privacy, regulatory or vendor procedures.

## Mandatory Batch B-2 controls
These audit-derived controls are mandatory before more invasive remediation.

### Pre-checks
1. Test Outlook on the web to confirm mailbox/service health.
2. Check MDM/Intune compliance, application protection policy and account licensing.
3. Check the installed Outlook mobile version and managed configuration.

### Rollback / undo
- Record the current managed app/profile state. If an approved app/profile change breaks synchronisation, restore or redeploy the previous approved managed configuration.
