...
description: Enterprise runbook to collect security incident evidence without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for collect security incident evidence, verify the original business task, and escalate with complete
