...
description: >-
  Enterprise runbook to collect security incident evidence without skipping evidence, verification, rollback or
...
tldr: >-
  ...
  remediation for collect security incident evidence, verify the original business task, and escalate with complete logs
