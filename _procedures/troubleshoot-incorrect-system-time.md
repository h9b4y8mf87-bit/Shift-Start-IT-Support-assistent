...
description: Enterprise runbook to troubleshoot incorrect system time without skipping evidence, verification, rollback
...
tldr: Confirm scope and authorisation, capture evidence, isolate the failing layer, apply the least disruptive approved
  remediation for troubleshoot incorrect system time, verify the original business task, and escalate with complete
